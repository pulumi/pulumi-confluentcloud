...
func (o LookupPrivateLinkAccessResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupPrivateLinkAccessResult] {
	return pulumix.Output[LookupPrivateLinkAccessResult]{
