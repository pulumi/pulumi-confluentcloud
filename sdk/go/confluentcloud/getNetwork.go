...
// page_title: "Network " pulumi-lang-python="Data Source - terraform-provider-confluent"
// subcategory: ""
// description: |-
//
// ***
...
func LookupNetworkOutput(ctx *pulumi.Context, args LookupNetworkOutputArgs, opts ...pulumi.InvokeOption) LookupNetworkResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNetworkResultOutput, error) {
			...
			return ctx.InvokeOutput("confluentcloud:index/getNetwork:getNetwork", args, LookupNetworkResultOutput{}, options).(LookupNetworkResultOutput), nil
