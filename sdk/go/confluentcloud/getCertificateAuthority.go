...
func LookupCertificateAuthorityOutput(ctx *pulumi.Context, args LookupCertificateAuthorityOutputArgs, opts ...pulumi.InvokeOption) LookupCertificateAuthorityResultOutput {
	...
	return ctx.InvokeOutput("confluentcloud:index/getCertificateAuthority:getCertificateAuthority", args, LookupCertificateAuthorityResultOutput{}, options).(LookupCertificateAuthorityResultOutput)
}
