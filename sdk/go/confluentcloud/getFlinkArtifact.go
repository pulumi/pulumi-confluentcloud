...
//			exampleUsingId, err := confluentcloud.GetFlinkArtifact(ctx, &confluentcloud.LookupFlinkArtifactArgs{
...
//			exampleUsingName, err := confluentcloud.GetFlinkArtifact(ctx, &confluentcloud.LookupFlinkArtifactArgs{
