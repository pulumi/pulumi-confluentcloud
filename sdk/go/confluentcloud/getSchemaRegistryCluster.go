...
func (o LookupSchemaRegistryClusterResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupSchemaRegistryClusterResult] {
	return pulumix.Output[LookupSchemaRegistryClusterResult]{
