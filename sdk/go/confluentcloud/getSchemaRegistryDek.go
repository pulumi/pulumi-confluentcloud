...
//			_, err := confluentcloud.GetSchemaRegistryDek(ctx, &confluentcloud.LookupSchemaRegistryDekArgs{
...
func LookupSchemaRegistryDekOutput(ctx *pulumi.Context, args LookupSchemaRegistryDekOutputArgs, opts ...pulumi.InvokeOption) LookupSchemaRegistryDekResultOutput {
	...
	return ctx.InvokeOutput("confluentcloud:index/getSchemaRegistryDek:getSchemaRegistryDek", args, LookupSchemaRegistryDekResultOutput{}, options).(LookupSchemaRegistryDekResultOutput)
}
