...
//				CrnPattern: pulumi.String(pulumi.String(exampleUsingName.ResourceName)),
//			})
//			if err != nil {
//				return err
//			}
...
func LookupEnvironmentOutput(ctx *pulumi.Context, args LookupEnvironmentOutputArgs, opts ...pulumi.InvokeOption) LookupEnvironmentResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEnvironmentResultOutput, error) {
			...
			return ctx.InvokeOutput("confluentcloud:index/getEnvironment:getEnvironment", args, LookupEnvironmentResultOutput{}, options).(LookupEnvironmentResultOutput), nil
