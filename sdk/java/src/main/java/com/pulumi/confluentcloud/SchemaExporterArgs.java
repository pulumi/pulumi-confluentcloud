...
public final class SchemaExporterArgs extends com.pulumi.resources.ResourceArgs {

    public static final SchemaExporterArgs Empty = new SchemaExporterArgs();
    ...
    @Import(name="destinationSchemaRegistryCluster", required=true)
    private Output<SchemaExporterDestinationSchemaRegistryClusterArgs> destinationSchemaRegistryCluster;

    public Output<SchemaExporterDestinationSchemaRegistryClusterArgs> destinationSchemaRegistryCluster() {
    ...
    private SchemaExporterArgs() {}

    private SchemaExporterArgs(SchemaExporterArgs $) {
        this.config = $.config;
    ...
    public static Builder builder(SchemaExporterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SchemaExporterArgs();
        }

        public Builder(SchemaExporterArgs defaults) {
            $ = new SchemaExporterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder destinationSchemaRegistryCluster(Output<SchemaExporterDestinationSchemaRegistryClusterArgs> destinationSchemaRegistryCluster) {
