...
public final class KafkaClientQuotaArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The list of service accounts to apply the Kafka Client Quota to. Use the special name, &#34;default&#34;,  to represent the default quota for all users and service accounts.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param principals The list of service accounts to apply the Kafka Client Quota to. Use the special name, &#34;default&#34;,  to represent the default quota for all users and service accounts.
         * 
         * @return builder
         * 
         */
