...
@CustomType
public final class BusinessMetadataCredentials {
    /**
    ...
    private BusinessMetadataCredentials() {}
    /**
     * @return The Schema Registry API Key.
     * 
     */
    ...
    public static Builder builder(BusinessMetadataCredentials defaults) {
    ...
    public static final class Builder {
        ...
        private String secret;
        public Builder() {}
        public Builder(BusinessMetadataCredentials defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("BusinessMetadataCredentials", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("BusinessMetadataCredentials", "secret");
            }
            this.secret = secret;
            return this;
        }
        public BusinessMetadataCredentials build() {
            final var _resultValue = new BusinessMetadataCredentials();
