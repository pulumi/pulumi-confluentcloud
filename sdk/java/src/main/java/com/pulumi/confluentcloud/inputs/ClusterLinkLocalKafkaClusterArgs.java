...
public final class ClusterLinkLocalKafkaClusterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param bootstrapEndpoint The bootstrap endpoint of the local Kafka cluster, for example, `SASL_SSL://pkc-00000.us-central1.gcp.confluent.cloud:9092` or `pkc-00000.us-central1.gcp.confluent.cloud:9092`).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param id The ID of the local Kafka cluster, for example, `lkc-abc123`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param restEndpoint The REST endpoint of the local Kafka cluster, for example, `https://pkc-00000.us-central1.gcp.confluent.cloud:443`).
         * 
         * @return builder
         * 
         */
