 ...
 * 
 * `confluentcloud.Environment` provides an Environment resource. The resource lets you create, edit and delete environments on Confluent Cloud.
 * 
 * &gt; **Note:** It is recommended to set `lifecycle { preventDestroy = true }` on production instances to prevent accidental Environment deletion. This setting rejects plans that would destroy or recreate the Environment, such as attempting to change uneditable attributes. Read more about it in the Terraform docs.
 * 
 * ## Example Usage
 * 
 * <pre>
...
public class Environment extends com.pulumi.resources.CustomResource {
    ...
    public Environment(java.lang.String name, @Nullable EnvironmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("confluentcloud:index/environment:Environment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Environment(java.lang.String name, Output<java.lang.String> id, @Nullable EnvironmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("confluentcloud:index/environment:Environment", name, state, makeResourceOptions(options, id), false);
    }
