...
public class Invitation extends com.pulumi.resources.CustomResource {
    ...
    public Invitation(java.lang.String name, InvitationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("confluentcloud:index/invitation:Invitation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Invitation(java.lang.String name, Output<java.lang.String> id, @Nullable InvitationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("confluentcloud:index/invitation:Invitation", name, state, makeResourceOptions(options, id), false);
    }
