...
public final class GroupMappingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupMappingArgs Empty = new GroupMappingArgs();
    ...
    private GroupMappingArgs() {}

    private GroupMappingArgs(GroupMappingArgs $) {
    ...
    public static Builder builder(GroupMappingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupMappingArgs();
        }

        public Builder(GroupMappingArgs defaults) {
            $ = new GroupMappingArgs(Objects.requireNonNull(defaults));
        }
