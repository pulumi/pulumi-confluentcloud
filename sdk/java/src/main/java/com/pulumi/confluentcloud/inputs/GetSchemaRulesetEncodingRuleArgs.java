...
public final class GetSchemaRulesetEncodingRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetSchemaRulesetEncodingRuleArgs Empty = new GetSchemaRulesetEncodingRuleArgs();
    ...
    private GetSchemaRulesetEncodingRuleArgs() {}

    private GetSchemaRulesetEncodingRuleArgs(GetSchemaRulesetEncodingRuleArgs $) {
    ...
    public static Builder builder(GetSchemaRulesetEncodingRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSchemaRulesetEncodingRuleArgs();
        }

        public Builder(GetSchemaRulesetEncodingRuleArgs defaults) {
            $ = new GetSchemaRulesetEncodingRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSchemaRulesetEncodingRuleArgs build() {
            if ($.kind == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRuleArgs", "kind");
            }
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRuleArgs", "mode");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRuleArgs", "name");
            }
            if ($.params == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRuleArgs", "params");
            }
            if ($.tags == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRuleArgs", "tags");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRuleArgs", "type");
            }
            return $;
        }
    }
