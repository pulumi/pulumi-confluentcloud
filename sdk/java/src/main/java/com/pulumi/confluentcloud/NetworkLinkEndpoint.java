...
public class NetworkLinkEndpoint extends com.pulumi.resources.CustomResource {
     ...
     */
    public NetworkLinkEndpoint(String name) {
     ...
     */
    public static NetworkLinkEndpoint get(String name, Output<String> id, @Nullable NetworkLinkEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
