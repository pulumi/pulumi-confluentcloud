...
@CustomType
public final class GetBusinessMetadataBindingSchemaRegistryCluster {
    /**
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetBusinessMetadataBindingSchemaRegistryCluster", "id");
            }
            this.id = id;
            return this;
        }
