...
public final class TableflowTopicGoogleCloudStorageArgs extends com.pulumi.resources.ResourceArgs {

    public static final TableflowTopicGoogleCloudStorageArgs Empty = new TableflowTopicGoogleCloudStorageArgs();
    ...
    private TableflowTopicGoogleCloudStorageArgs() {}

    private TableflowTopicGoogleCloudStorageArgs(TableflowTopicGoogleCloudStorageArgs $) {
    ...
    public static Builder builder(TableflowTopicGoogleCloudStorageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TableflowTopicGoogleCloudStorageArgs();
        }

        public Builder(TableflowTopicGoogleCloudStorageArgs defaults) {
            $ = new TableflowTopicGoogleCloudStorageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TableflowTopicGoogleCloudStorageArgs build() {
            if ($.bucketName == null) {
                throw new MissingRequiredPropertyException("TableflowTopicGoogleCloudStorageArgs", "bucketName");
            }
            if ($.providerIntegrationId == null) {
                throw new MissingRequiredPropertyException("TableflowTopicGoogleCloudStorageArgs", "providerIntegrationId");
            }
            return $;
        }
    }
