...
public final class ClusterLinkSourceKafkaClusterCredentialsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ClusterLinkSourceKafkaClusterCredentialsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("ClusterLinkSourceKafkaClusterCredentialsArgs", "key");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("ClusterLinkSourceKafkaClusterCredentialsArgs", "secret");
            }
            return $;
        }
    }
