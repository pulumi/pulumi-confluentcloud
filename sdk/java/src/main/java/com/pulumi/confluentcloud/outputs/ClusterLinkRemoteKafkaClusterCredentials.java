...
public final class ClusterLinkRemoteKafkaClusterCredentials {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("ClusterLinkRemoteKafkaClusterCredentials", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("ClusterLinkRemoteKafkaClusterCredentials", "secret");
            }
            this.secret = secret;
            return this;
        }
