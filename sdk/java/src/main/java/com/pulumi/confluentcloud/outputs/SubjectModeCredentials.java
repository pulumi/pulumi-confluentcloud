...
public final class SubjectModeCredentials {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("SubjectModeCredentials", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("SubjectModeCredentials", "secret");
            }
            this.secret = secret;
            return this;
        }
        public SubjectModeCredentials build() {
            final var _resultValue = new SubjectModeCredentials();
