...
public final class GetPrivateLinkAttachmentConnectionPrivateLinkAttachment {
    ...
    public static Builder builder(GetPrivateLinkAttachmentConnectionPrivateLinkAttachment defaults) {
    ...
    public static final class Builder {
        private String id;
        public Builder() {}
        public Builder(GetPrivateLinkAttachmentConnectionPrivateLinkAttachment defaults) {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetPrivateLinkAttachmentConnectionPrivateLinkAttachment", "id");
            }
            this.id = id;
            return this;
        }
