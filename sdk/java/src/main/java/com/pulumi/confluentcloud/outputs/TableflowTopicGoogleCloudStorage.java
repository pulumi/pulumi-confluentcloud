...
@CustomType
public final class TableflowTopicGoogleCloudStorage {
    /**
    ...
    private TableflowTopicGoogleCloudStorage() {}
    /**
     * @return The bucket name.
     * 
     */
    ...
    public static Builder builder(TableflowTopicGoogleCloudStorage defaults) {
    ...
    public static final class Builder {
        ...
        private String providerIntegrationId;
        public Builder() {}
        public Builder(TableflowTopicGoogleCloudStorage defaults) {
        ...
        public Builder bucketName(String bucketName) {
            if (bucketName == null) {
              throw new MissingRequiredPropertyException("TableflowTopicGoogleCloudStorage", "bucketName");
            }
        ...
        public Builder providerIntegrationId(String providerIntegrationId) {
            if (providerIntegrationId == null) {
              throw new MissingRequiredPropertyException("TableflowTopicGoogleCloudStorage", "providerIntegrationId");
            }
            this.providerIntegrationId = providerIntegrationId;
            return this;
        }
        public TableflowTopicGoogleCloudStorage build() {
            final var _resultValue = new TableflowTopicGoogleCloudStorage();
