...
public final class GetFlinkMaterializedTableCredentials extends com.pulumi.resources.InvokeArgs {

    public static final GetFlinkMaterializedTableCredentials Empty = new GetFlinkMaterializedTableCredentials();
    ...
    private GetFlinkMaterializedTableCredentials() {}

    private GetFlinkMaterializedTableCredentials(GetFlinkMaterializedTableCredentials $) {
        this.key = $.key;
        this.secret = $.secret;
    }
    ...
    public static Builder builder(GetFlinkMaterializedTableCredentials defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFlinkMaterializedTableCredentials();
        }

        public Builder(GetFlinkMaterializedTableCredentials defaults) {
            $ = new GetFlinkMaterializedTableCredentials(Objects.requireNonNull(defaults));
        }
        ...
        public GetFlinkMaterializedTableCredentials build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetFlinkMaterializedTableCredentials", "key");
            }
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("GetFlinkMaterializedTableCredentials", "secret");
            }
            return $;
        }
    }
