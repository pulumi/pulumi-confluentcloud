...
public class SchemaRegistryCluster extends com.pulumi.resources.CustomResource {
     ...
     */
    public SchemaRegistryCluster(java.lang.String name) {
     ...
     */
    public SchemaRegistryCluster(java.lang.String name, SchemaRegistryClusterArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SchemaRegistryCluster(java.lang.String name, SchemaRegistryClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("confluentcloud:index/schemaRegistryCluster:SchemaRegistryCluster", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SchemaRegistryCluster(java.lang.String name, Output<java.lang.String> id, @Nullable SchemaRegistryClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("confluentcloud:index/schemaRegistryCluster:SchemaRegistryCluster", name, state, makeResourceOptions(options, id), false);
    }

    private static SchemaRegistryClusterArgs makeArgs(SchemaRegistryClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SchemaRegistryClusterArgs.Empty : args;
    }
     ...
     */
    public static SchemaRegistryCluster get(java.lang.String name, Output<java.lang.String> id, @Nullable SchemaRegistryClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
