...
public final class GetSchemaRulesetMigrationRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetSchemaRulesetMigrationRuleArgs Empty = new GetSchemaRulesetMigrationRuleArgs();
    ...
    private GetSchemaRulesetMigrationRuleArgs() {}

    private GetSchemaRulesetMigrationRuleArgs(GetSchemaRulesetMigrationRuleArgs $) {
        this.doc = $.doc;
        this.expr = $.expr;
        this.kind = $.kind;
        this.mode = $.mode;
    ...
    public static Builder builder(GetSchemaRulesetMigrationRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSchemaRulesetMigrationRuleArgs();
        }

        public Builder(GetSchemaRulesetMigrationRuleArgs defaults) {
            $ = new GetSchemaRulesetMigrationRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSchemaRulesetMigrationRuleArgs build() {
            if ($.doc == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "doc");
            }
            if ($.expr == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "expr");
            }
            if ($.kind == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "kind");
            }
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "mode");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "name");
            }
            if ($.onFailure == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "onFailure");
            }
            if ($.onSuccess == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "onSuccess");
            }
            if ($.params == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "params");
            }
            if ($.tags == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "tags");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetMigrationRuleArgs", "type");
            }
            return $;
        }
    }
