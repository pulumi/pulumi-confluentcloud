...
@CustomType
public final class PrivateLinkAccessGcp {
    /**
    ...
    public static Builder builder(PrivateLinkAccessGcp defaults) {
    ...
    public static final class Builder {
        private String project;
        public Builder() {}
        public Builder(PrivateLinkAccessGcp defaults) {
        ...
        public Builder project(String project) {
            if (project == null) {
              throw new MissingRequiredPropertyException("PrivateLinkAccessGcp", "project");
            }
            this.project = project;
            return this;
        }
        public PrivateLinkAccessGcp build() {
            final var _resultValue = new PrivateLinkAccessGcp();
