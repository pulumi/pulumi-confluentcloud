...
public final class SchemaRegistryClusterConfigState extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(SchemaRegistryClusterConfigState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SchemaRegistryClusterConfigState();
        }
        ...
        public SchemaRegistryClusterConfigState build() {
            return $;
        }
    }
