...
@CustomType
public final class GetKafkaClusterEndpoint {
    /**
    ...
    private GetKafkaClusterEndpoint() {}
    /**
     * @return (Required String) The ID of the Access Point that the endpoint corresponds to. Access Point IDs `PUBLIC` and `PRIVATE_LINK` are reserved.
     * 
     */
    ...
    public static Builder builder(GetKafkaClusterEndpoint defaults) {
    ...
    public static final class Builder {
        ...
        private String restEndpoint;
        public Builder() {}
        public Builder(GetKafkaClusterEndpoint defaults) {
        ...
        public Builder accessPointId(String accessPointId) {
            if (accessPointId == null) {
              throw new MissingRequiredPropertyException("GetKafkaClusterEndpoint", "accessPointId");
            }
        ...
        public Builder bootstrapEndpoint(String bootstrapEndpoint) {
            if (bootstrapEndpoint == null) {
              throw new MissingRequiredPropertyException("GetKafkaClusterEndpoint", "bootstrapEndpoint");
            }
        ...
        public Builder connectionType(String connectionType) {
            if (connectionType == null) {
              throw new MissingRequiredPropertyException("GetKafkaClusterEndpoint", "connectionType");
            }
        ...
        public Builder restEndpoint(String restEndpoint) {
            if (restEndpoint == null) {
              throw new MissingRequiredPropertyException("GetKafkaClusterEndpoint", "restEndpoint");
            }
            this.restEndpoint = restEndpoint;
            return this;
        }
        public GetKafkaClusterEndpoint build() {
            final var _resultValue = new GetKafkaClusterEndpoint();
