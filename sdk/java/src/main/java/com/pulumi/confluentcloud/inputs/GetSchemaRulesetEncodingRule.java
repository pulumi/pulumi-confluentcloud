...
public final class GetSchemaRulesetEncodingRule extends com.pulumi.resources.InvokeArgs {

    public static final GetSchemaRulesetEncodingRule Empty = new GetSchemaRulesetEncodingRule();
    ...
    private GetSchemaRulesetEncodingRule() {}

    private GetSchemaRulesetEncodingRule(GetSchemaRulesetEncodingRule $) {
    ...
    public static Builder builder(GetSchemaRulesetEncodingRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSchemaRulesetEncodingRule();
        }

        public Builder(GetSchemaRulesetEncodingRule defaults) {
            $ = new GetSchemaRulesetEncodingRule(Objects.requireNonNull(defaults));
        }
        ...
        public GetSchemaRulesetEncodingRule build() {
            if ($.kind == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRule", "kind");
            }
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRule", "mode");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRule", "name");
            }
            if ($.params == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRule", "params");
            }
            if ($.tags == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRule", "tags");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("GetSchemaRulesetEncodingRule", "type");
            }
            return $;
        }
    }
