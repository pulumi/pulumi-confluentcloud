...
def get_service_account(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: A human-readable name for the Service Account. Limited to 64 characters in length.
           
           > **Note:** Exactly one from the `id` and `display_name` attributes must be specified.
    :param builtins.str id: The ID of the Service Account (e.g., `sa-abc123`).
    """
    __args__ = dict()
...
def get_service_account_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
