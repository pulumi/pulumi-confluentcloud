...
def get_byok_key(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The ID of the BYOK key, for example, `cck-abcde`.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_byok_key_output(id: Optional[pulumi.Input[builtins.str]] = None,
