...
class GetSchemaResult:
    ...
    def hard_delete(self) -> builtins.bool:
    ...
    def recreate_on_update(self) -> builtins.bool:
    ...
    def skip_validation_during_plan(self) -> builtins.bool:
...
def get_schema(credentials: Optional[Union['GetSchemaCredentialsArgs', 'GetSchemaCredentialsArgsDict']] = None,
               ...
               schema_identifier: Optional[builtins.int] = None,
    ...
    :param builtins.int schema_identifier: The globally unique ID of the Schema, for example, `100003`. If the same schema is registered under a different subject, the same identifier will be returned. However, the `version` of the schema may be different under different subjects.
...
def get_schema_output(credentials: Optional[pulumi.Input[Optional[Union['GetSchemaCredentialsArgs', 'GetSchemaCredentialsArgsDict']]]] = None,
                      ...
                      schema_identifier: Optional[pulumi.Input[builtins.int]] = None,
