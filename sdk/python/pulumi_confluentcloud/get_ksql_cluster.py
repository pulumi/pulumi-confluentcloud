...
class GetKsqlClusterResult:
    ...
    def topic_prefix(self) -> builtins.str:
        """
    ...
    def use_detailed_processing_log(self) -> builtins.bool:
        """
...
def get_ksql_cluster(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: The name of the ksqlDB cluster.
...
def get_ksql_cluster_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
