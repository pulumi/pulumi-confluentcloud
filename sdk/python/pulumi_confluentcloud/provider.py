...
class ProviderArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if cloud_api_key is None and 'cloudApiKey' in kwargs:
            cloud_api_key = kwargs['cloudApiKey']
        if cloud_api_secret is None and 'cloudApiSecret' in kwargs:
            cloud_api_secret = kwargs['cloudApiSecret']
        if kafka_api_key is None and 'kafkaApiKey' in kwargs:
            kafka_api_key = kwargs['kafkaApiKey']
        if kafka_api_secret is None and 'kafkaApiSecret' in kwargs:
            kafka_api_secret = kwargs['kafkaApiSecret']
        if kafka_id is None and 'kafkaId' in kwargs:
            kafka_id = kwargs['kafkaId']
        if kafka_rest_endpoint is None and 'kafkaRestEndpoint' in kwargs:
            kafka_rest_endpoint = kwargs['kafkaRestEndpoint']
        if max_retries is None and 'maxRetries' in kwargs:
            max_retries = kwargs['maxRetries']
        if schema_registry_api_key is None and 'schemaRegistryApiKey' in kwargs:
            schema_registry_api_key = kwargs['schemaRegistryApiKey']
        if schema_registry_api_secret is None and 'schemaRegistryApiSecret' in kwargs:
            schema_registry_api_secret = kwargs['schemaRegistryApiSecret']
        if schema_registry_id is None and 'schemaRegistryId' in kwargs:
            schema_registry_id = kwargs['schemaRegistryId']
        if schema_registry_rest_endpoint is None and 'schemaRegistryRestEndpoint' in kwargs:
            schema_registry_rest_endpoint = kwargs['schemaRegistryRestEndpoint']
