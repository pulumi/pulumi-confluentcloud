...
class CertificatePoolArgs:
    def __init__(__self__, *,
                 ...
                 external_identifier: pulumi.Input[builtins.str],
                 filter: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a CertificatePool resource.
        :param pulumi.Input[builtins.str] description: A description of the Certificate Pool.
        :param pulumi.Input[builtins.str] display_name: The name of the Certificate Pool.
        :param pulumi.Input[builtins.str] external_identifier: The certificate field that will be used to represent the pool's external identity for audit logging.
        :param pulumi.Input[builtins.str] filter: A filter expression in [Supported Common Expression Language (CEL)](https://docs.confluent.io/cloud/current/access-management/authenticate/mtls/cel-filters.html) that specifies which identities can authenticate using your certificate pool.
        """
    ...
    def external_identifier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_identifier(self, value: pulumi.Input[builtins.str]):
...
class _CertificatePoolState:
    def __init__(__self__, *,
                 ...
                 external_identifier: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="externalIdentifier")
    def external_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The certificate field that will be used to represent the pool's external identity for audit logging.
        """
        return pulumi.get(self, "external_identifier")
    ...
    @external_identifier.setter
    def external_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_identifier", value)
...
class CertificatePool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[builtins.str]] = None,
            external_identifier: Optional[pulumi.Input[builtins.str]] = None,
            filter: Optional[pulumi.Input[builtins.str]] = None) -> 'CertificatePool':
        """
    ...
    @property
    @pulumi.getter(name="externalIdentifier")
    def external_identifier(self) -> pulumi.Output[builtins.str]:
        """
        The certificate field that will be used to represent the pool's external identity for audit logging.
        """
        return pulumi.get(self, "external_identifier")
