...
class SchemaExporter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if credentials is not None and not isinstance(credentials, SchemaExporterCredentialsArgs):
                credentials = credentials or {}
                def _setter(key, value):
                    credentials[key] = value
                SchemaExporterCredentialsArgs._configure(_setter, **credentials)
            __props__.__dict__["credentials"] = None if credentials is None else pulumi.Output.secret(credentials)
            if destination_schema_registry_cluster is not None and not isinstance(destination_schema_registry_cluster, SchemaExporterDestinationSchemaRegistryClusterArgs):
                destination_schema_registry_cluster = destination_schema_registry_cluster or {}
                def _setter(key, value):
                    destination_schema_registry_cluster[key] = value
                SchemaExporterDestinationSchemaRegistryClusterArgs._configure(_setter, **destination_schema_registry_cluster)
            ...
            if schema_registry_cluster is not None and not isinstance(schema_registry_cluster, SchemaExporterSchemaRegistryClusterArgs):
                schema_registry_cluster = schema_registry_cluster or {}
                def _setter(key, value):
                    schema_registry_cluster[key] = value
                SchemaExporterSchemaRegistryClusterArgs._configure(_setter, **schema_registry_cluster)
