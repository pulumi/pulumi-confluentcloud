...
class GetClusterLinkResult:
    ...
    def cluster_link_id(self) -> builtins.str:
        """
    ...
    def link_state(self) -> builtins.str:
        """
...
def get_cluster_link(credentials: Optional[Union['GetClusterLinkCredentialsArgs', 'GetClusterLinkCredentialsArgsDict']] = None,
    ...
    :param builtins.str link_name: The name of the cluster link, for example, `my-cluster-link`.
