...
def get_schema_registry_cluster_config(credentials: Optional[Union['GetSchemaRegistryClusterConfigCredentialsArgs', 'GetSchemaRegistryClusterConfigCredentialsArgsDict', 'outputs.GetSchemaRegistryClusterConfigCredentialsResult']] = None,
                                       rest_endpoint: Optional[_builtins.str] = None,
                                       schema_registry_cluster: Optional[Union['GetSchemaRegistryClusterConfigSchemaRegistryClusterArgs', 'GetSchemaRegistryClusterConfigSchemaRegistryClusterArgsDict', 'outputs.GetSchemaRegistryClusterConfigSchemaRegistryClusterResult']] = None,
...
def get_schema_registry_cluster_config_output(credentials: pulumi.Input[Optional[Optional[Union['GetSchemaRegistryClusterConfigCredentialsArgs', 'GetSchemaRegistryClusterConfigCredentialsArgsDict', 'outputs.GetSchemaRegistryClusterConfigCredentialsResult']]]] = None,
                                              rest_endpoint: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                              schema_registry_cluster: pulumi.Input[Optional[Optional[Union['GetSchemaRegistryClusterConfigSchemaRegistryClusterArgs', 'GetSchemaRegistryClusterConfigSchemaRegistryClusterArgsDict', 'outputs.GetSchemaRegistryClusterConfigSchemaRegistryClusterResult']]]] = None,
