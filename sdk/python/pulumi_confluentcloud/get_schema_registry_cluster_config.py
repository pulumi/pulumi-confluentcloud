...
def get_schema_registry_cluster_config_output(credentials: pulumi.Input[Optional[Optional[Union['GetSchemaRegistryClusterConfigCredentialsArgs', 'GetSchemaRegistryClusterConfigCredentialsArgsDict']]]] = None,
                                              rest_endpoint: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                              schema_registry_cluster: pulumi.Input[Optional[Optional[Union['GetSchemaRegistryClusterConfigSchemaRegistryClusterArgs', 'GetSchemaRegistryClusterConfigSchemaRegistryClusterArgsDict']]]] = None,
