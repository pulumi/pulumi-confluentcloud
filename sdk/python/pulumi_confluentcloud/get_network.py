...
class GetNetworkResult:
    ...
    def reserved_cidr(self) -> builtins.str:
        """
    ...
    def zonal_subdomains(self) -> Mapping[str, builtins.str]:
...
def get_network(aws: Optional[Sequence[Union['GetNetworkAwArgs', 'GetNetworkAwArgsDict']]] = None,
    ...
    :param builtins.str display_name: A human-readable name for the Network.
