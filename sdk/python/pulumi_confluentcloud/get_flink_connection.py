...
def get_flink_connection(compute_pool: Optional[Union['GetFlinkConnectionComputePoolArgs', 'GetFlinkConnectionComputePoolArgsDict', 'outputs.GetFlinkConnectionComputePoolResult']] = None,
                         credentials: Optional[Union['GetFlinkConnectionCredentialsArgs', 'GetFlinkConnectionCredentialsArgsDict', 'outputs.GetFlinkConnectionCredentialsResult']] = None,
                         display_name: Optional[_builtins.str] = None,
                         environment: Optional[Union['GetFlinkConnectionEnvironmentArgs', 'GetFlinkConnectionEnvironmentArgsDict', 'outputs.GetFlinkConnectionEnvironmentResult']] = None,
                         organization: Optional[Union['GetFlinkConnectionOrganizationArgs', 'GetFlinkConnectionOrganizationArgsDict', 'outputs.GetFlinkConnectionOrganizationResult']] = None,
                         principal: Optional[Union['GetFlinkConnectionPrincipalArgs', 'GetFlinkConnectionPrincipalArgsDict', 'outputs.GetFlinkConnectionPrincipalResult']] = None,
...
def get_flink_connection_output(compute_pool: pulumi.Input[Optional[Optional[Union['GetFlinkConnectionComputePoolArgs', 'GetFlinkConnectionComputePoolArgsDict', 'outputs.GetFlinkConnectionComputePoolResult']]]] = None,
                                credentials: pulumi.Input[Optional[Optional[Union['GetFlinkConnectionCredentialsArgs', 'GetFlinkConnectionCredentialsArgsDict', 'outputs.GetFlinkConnectionCredentialsResult']]]] = None,
                                display_name: pulumi.Input[Optional[_builtins.str]] = None,
                                environment: pulumi.Input[Optional[Optional[Union['GetFlinkConnectionEnvironmentArgs', 'GetFlinkConnectionEnvironmentArgsDict', 'outputs.GetFlinkConnectionEnvironmentResult']]]] = None,
                                organization: pulumi.Input[Optional[Optional[Union['GetFlinkConnectionOrganizationArgs', 'GetFlinkConnectionOrganizationArgsDict', 'outputs.GetFlinkConnectionOrganizationResult']]]] = None,
                                principal: pulumi.Input[Optional[Optional[Union['GetFlinkConnectionPrincipalArgs', 'GetFlinkConnectionPrincipalArgsDict', 'outputs.GetFlinkConnectionPrincipalResult']]]] = None,
