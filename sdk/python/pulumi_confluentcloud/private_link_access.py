...
class PrivateLinkAccessArgs:
    def __init__(__self__, *,
        ...
        """
        PrivateLinkAccessArgs._configure(
...
class _PrivateLinkAccessState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['PrivateLinkAccessNetworkArgs'] network: Network represents a network (VPC) in Confluent Cloud. All Networks exist within Confluent-managed cloud provider
               accounts.
        """
        _PrivateLinkAccessState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            aws=aws,
            azure=azure,
            display_name=display_name,
...
class PrivateLinkAccess(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PrivateLinkAccessArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if aws is not None and not isinstance(aws, PrivateLinkAccessAwsArgs):
                aws = aws or {}
                def _setter(key, value):
                    aws[key] = value
                PrivateLinkAccessAwsArgs._configure(_setter, **aws)
            __props__.__dict__["aws"] = aws
            if azure is not None and not isinstance(azure, PrivateLinkAccessAzureArgs):
                azure = azure or {}
                def _setter(key, value):
                    azure[key] = value
                PrivateLinkAccessAzureArgs._configure(_setter, **azure)
            __props__.__dict__["azure"] = azure
            __props__.__dict__["display_name"] = display_name
            if environment is not None and not isinstance(environment, PrivateLinkAccessEnvironmentArgs):
                environment = environment or {}
                def _setter(key, value):
                    environment[key] = value
                PrivateLinkAccessEnvironmentArgs._configure(_setter, **environment)
            if environment is None and not opts.urn:
                raise TypeError("Missing required property 'environment'")
            __props__.__dict__["environment"] = environment
            if gcp is not None and not isinstance(gcp, PrivateLinkAccessGcpArgs):
                gcp = gcp or {}
                def _setter(key, value):
                    gcp[key] = value
                PrivateLinkAccessGcpArgs._configure(_setter, **gcp)
            __props__.__dict__["gcp"] = gcp
            if network is not None and not isinstance(network, PrivateLinkAccessNetworkArgs):
                network = network or {}
                def _setter(key, value):
                    network[key] = value
                PrivateLinkAccessNetworkArgs._configure(_setter, **network)
