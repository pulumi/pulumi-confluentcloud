...
class SchemaRegistryKekArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The ID of the key from KMS. 
        ...
        :param pulumi.Input[builtins.str] kms_type: The type of Key Management Service (KMS). The supported values include `aws-kms`, `azure-kms`, and `gcp-kms`. Additionally, custom KMS types are supported as well.
        :param pulumi.Input['SchemaRegistryKekCredentialsArgs'] credentials: The Cluster API Credentials.
        :param pulumi.Input[builtins.str] doc: The optional description for the KEK.
        :param pulumi.Input[builtins.bool] hard_delete: Controls whether a kek should be soft or hard deleted. Set it to `true` if you want to hard delete a schema registry kek
               on destroy. Defaults to `false` (soft delete).
        :param pulumi.Input[builtins.str] name: The name for the KEK.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: The custom properties to set (for example, `KeyUsage=ENCRYPT_DECRYPT`, `KeyState=Enabled`):
        ...
        :param pulumi.Input[builtins.bool] shared: The optional flag to control whether the DEK Registry has shared access to the KMS. Defaults to `false`.
        """
    ...
    def kms_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @kms_type.setter
    def kms_type(self, value: pulumi.Input[builtins.str]):
    ...
    @hard_delete.setter
    def hard_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SchemaRegistryKekState:
    def __init__(__self__, *,
                 ...
                 kms_type: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 rest_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 schema_registry_cluster: Optional[pulumi.Input['SchemaRegistryKekSchemaRegistryClusterArgs']] = None,
    ...
    @property
    @pulumi.getter(name="kmsType")
    def kms_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of Key Management Service (KMS). The supported values include `aws-kms`, `azure-kms`, and `gcp-kms`. Additionally, custom KMS types are supported as well.
        """
        return pulumi.get(self, "kms_type")
    ...
    @kms_type.setter
    def kms_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kms_type", value)
...
class SchemaRegistryKek(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rest_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            schema_registry_cluster: Optional[pulumi.Input[Union['SchemaRegistryKekSchemaRegistryClusterArgs', 'SchemaRegistryKekSchemaRegistryClusterArgsDict']]] = None,
            shared: Optional[pulumi.Input[builtins.bool]] = None) -> 'SchemaRegistryKek':
        """
    ...
    @property
    @pulumi.getter
    def doc(self) -> pulumi.Output[builtins.str]:
        """
        The optional description for the KEK.
        """
        return pulumi.get(self, "doc")
    ...
    @property
    @pulumi.getter(name="kmsType")
    def kms_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of Key Management Service (KMS). The supported values include `aws-kms`, `azure-kms`, and `gcp-kms`. Additionally, custom KMS types are supported as well.
        """
        return pulumi.get(self, "kms_type")
