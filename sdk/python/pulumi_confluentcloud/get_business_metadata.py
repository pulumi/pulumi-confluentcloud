...
def get_business_metadata(credentials: Optional[Union['GetBusinessMetadataCredentialsArgs', 'GetBusinessMetadataCredentialsArgsDict', 'outputs.GetBusinessMetadataCredentialsResult']] = None,
                          name: Optional[_builtins.str] = None,
                          rest_endpoint: Optional[_builtins.str] = None,
                          schema_registry_cluster: Optional[Union['GetBusinessMetadataSchemaRegistryClusterArgs', 'GetBusinessMetadataSchemaRegistryClusterArgsDict', 'outputs.GetBusinessMetadataSchemaRegistryClusterResult']] = None,
...
def get_business_metadata_output(credentials: pulumi.Input[Optional[Optional[Union['GetBusinessMetadataCredentialsArgs', 'GetBusinessMetadataCredentialsArgsDict', 'outputs.GetBusinessMetadataCredentialsResult']]]] = None,
                                 name: pulumi.Input[Optional[_builtins.str]] = None,
                                 rest_endpoint: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 schema_registry_cluster: pulumi.Input[Optional[Optional[Union['GetBusinessMetadataSchemaRegistryClusterArgs', 'GetBusinessMetadataSchemaRegistryClusterArgsDict', 'outputs.GetBusinessMetadataSchemaRegistryClusterResult']]]] = None,
