...
class FlinkStatementArgs:
    def __init__(__self__, *,
                 ...
                 properties_sensitive: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    def properties_sensitive(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def properties_sensitive(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _FlinkStatementState:
    def __init__(__self__, *,
                 ...
                 credentials: Optional[pulumi.Input['FlinkStatementCredentialsArgs']] = None,
                 environment: Optional[pulumi.Input['FlinkStatementEnvironmentArgs']] = None,
                 latest_offsets: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 latest_offsets_timestamp: Optional[pulumi.Input[builtins.str]] = None,
                 organization: Optional[pulumi.Input['FlinkStatementOrganizationArgs']] = None,
                 principal: Optional[pulumi.Input['FlinkStatementPrincipalArgs']] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 properties_sensitive: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input['FlinkStatementCredentialsArgs'] credentials: The Cluster API Credentials.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] latest_offsets: (Optional String) The last Kafka offsets that a statement has processed. Represented by a mapping from Kafka topic to a string representation of partitions mapped to offsets. For example,
               ```bash
               "latest_offsets": {
    ...
    def latest_offsets(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def latest_offsets(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "latest_offsets", value)

    @property
    @pulumi.getter(name="latestOffsetsTimestamp")
    def latest_offsets_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def latest_offsets_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FlinkStatement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            statement: Optional[pulumi.Input[builtins.str]] = None,
            statement_name: Optional[pulumi.Input[builtins.str]] = None,
            stopped: Optional[pulumi.Input[builtins.bool]] = None) -> 'FlinkStatement':
        """
    ...
    @property
    @pulumi.getter(name="latestOffsets")
    def latest_offsets(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        (Optional String) The last Kafka offsets that a statement has processed. Represented by a mapping from Kafka topic to a string representation of partitions mapped to offsets. For example,
        ```bash
        "latest_offsets": {
    ...
    @property
    @pulumi.getter(name="latestOffsetsTimestamp")
    def latest_offsets_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        (Optional String) The date and time at which the Kafka topic offsets were added to the statement status. It is represented in RFC3339 format and is in UTC. For example, `2023-03-31T00:00:00-00:00`.
        """
        return pulumi.get(self, "latest_offsets_timestamp")
    ...
    @property
    @pulumi.getter(name="propertiesSensitive")
    def properties_sensitive(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Block for sensitive statement properties:
        """
        return pulumi.get(self, "properties_sensitive")
    ...
    @property
    @pulumi.getter(name="statementName")
    def statement_name(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Flink Statement, for example, `cfeab4fe-b62c-49bd-9e99-51cc98c77a67`.
        """
        return pulumi.get(self, "statement_name")
    ...
    @property
    @pulumi.getter
    def stopped(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the statement should be stopped.
        """
        return pulumi.get(self, "stopped")
