...
class SchemaRegistryClusterConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            credentials = _utilities.configure(credentials, SchemaRegistryClusterConfigCredentialsArgs, True)
            __props__.__dict__["credentials"] = None if credentials is None else pulumi.Output.secret(credentials)
            __props__.__dict__["rest_endpoint"] = rest_endpoint
            schema_registry_cluster = _utilities.configure(schema_registry_cluster, SchemaRegistryClusterConfigSchemaRegistryClusterArgs, True)
