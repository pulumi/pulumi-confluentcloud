...
class IdentityProviderArgs:
    def __init__(__self__, *,
                 ...
                 jwks_uri: pulumi.Input[builtins.str],
                 identity_claim: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IdentityProvider resource.
        :param pulumi.Input[builtins.str] description: A description for the Identity Provider.
        :param pulumi.Input[builtins.str] display_name: A human-readable name for the Identity Provider.
        :param pulumi.Input[builtins.str] issuer: A publicly reachable issuer URI for the Identity Provider. The unique issuer URI string represents the entity for issuing tokens.
        :param pulumi.Input[builtins.str] jwks_uri: A publicly reachable JSON Web Key Set (JWKS) URI for the Identity Provider. A JSON Web Key Set (JWKS) provides a set of keys containing the public keys used to verify any JSON Web Token (JWT) issued by your OAuth 2.0 identity provider.
        :param pulumi.Input[builtins.str] identity_claim: The JSON Web Token (JWT) claim to extract the authenticating identity to Confluent resources from [Registered Claim Names](https://datatracker.ietf.org/doc/html/rfc7519#section-4.1). This appears in audit log records.
    ...
    def jwks_uri(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @jwks_uri.setter
    def jwks_uri(self, value: pulumi.Input[builtins.str]):
...
class _IdentityProviderState:
    def __init__(__self__, *,
                 ...
                 jwks_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="jwksUri")
    def jwks_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A publicly reachable JSON Web Key Set (JWKS) URI for the Identity Provider. A JSON Web Key Set (JWKS) provides a set of keys containing the public keys used to verify any JSON Web Token (JWT) issued by your OAuth 2.0 identity provider.
        """
        return pulumi.get(self, "jwks_uri")
    ...
    @jwks_uri.setter
    def jwks_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "jwks_uri", value)
...
class IdentityProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            identity_claim: Optional[pulumi.Input[builtins.str]] = None,
            issuer: Optional[pulumi.Input[builtins.str]] = None,
            jwks_uri: Optional[pulumi.Input[builtins.str]] = None) -> 'IdentityProvider':
        """
    ...
    @property
    @pulumi.getter(name="identityClaim")
    def identity_claim(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The JSON Web Token (JWT) claim to extract the authenticating identity to Confluent resources from [Registered Claim Names](https://datatracker.ietf.org/doc/html/rfc7519#section-4.1). This appears in audit log records.
    ...
    @property
    @pulumi.getter(name="jwksUri")
    def jwks_uri(self) -> pulumi.Output[builtins.str]:
        """
        A publicly reachable JSON Web Key Set (JWKS) URI for the Identity Provider. A JSON Web Key Set (JWKS) provides a set of keys containing the public keys used to verify any JSON Web Token (JWT) issued by your OAuth 2.0 identity provider.
        """
        return pulumi.get(self, "jwks_uri")
