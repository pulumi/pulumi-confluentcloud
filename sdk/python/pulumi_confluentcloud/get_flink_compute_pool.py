...
def get_flink_compute_pool(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: A human-readable name for the Flink Compute Pool.
...
def get_flink_compute_pool_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
