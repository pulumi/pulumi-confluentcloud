...
class GetCertificateAuthorityResult:
    ...
    def certificate_chain_filename(self) -> builtins.str:
        """
    ...
    def crl_source(self) -> builtins.str:
        """
    ...
    def crl_updated_at(self) -> builtins.str:
        """
    ...
    def expiration_dates(self) -> Sequence[builtins.str]:
        """
    ...
    def serial_numbers(self) -> Sequence[builtins.str]:
        """
...
def get_certificate_authority(crl_source: Optional[builtins.str] = None,
                              crl_updated_at: Optional[builtins.str] = None,
                              crl_url: Optional[builtins.str] = None,
    ...
    :param builtins.str crl_source: (Optional String) The source specifies whether the Certificate Revocation List (CRL) is updated from either local file uploaded (LOCAL) or from url of CRL (URL). Accepted values are `LOCAL` and `URL`.
    :param builtins.str crl_updated_at: (Optional String) The timestamp for when CRL was last updated, for example, `2017-07-21T17:32:28Z`.
    :param builtins.str crl_url: (Optional String) The url from which to fetch the CRL for the certificate authority if crl_source is URL.
    :param builtins.str id: The ID of the Certificate Authority, for example, `op-abc123`.
    """
    __args__ = dict()
...
def get_certificate_authority_output(crl_source: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     crl_updated_at: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     crl_url: Optional[pulumi.Input[Optional[builtins.str]]] = None,
