...
class NetworkArgs:
    def __init__(__self__, *,
                 ...
                 connection_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 reserved_cidr: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cloud: The cloud service provider in which the network exists. Accepted values are: `AWS`, `AZURE`, and `GCP`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] connection_types: The list of connection types that may be used with the network. Accepted connection types are: `PEERING`, `TRANSITGATEWAY`, and `PRIVATELINK`.
        ...
        :param pulumi.Input[builtins.str] region: The cloud provider region where the network exists.
        ...
        :param pulumi.Input[builtins.str] cidr: The IPv4 CIDR block to be used for the network. Must be `/16`. Required for VPC peering and AWS TransitGateway.
        :param pulumi.Input[builtins.str] display_name: The name of the Network.
        ...
        :param pulumi.Input[builtins.str] reserved_cidr: The reserved IPv4 CIDR block to be used for the network. Must be `/24`. If not specified, Confluent Cloud Network uses `172.20.255.0/24`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: The 3 availability zones for this network. They can optionally be specified for AWS networks
    ...
    def connection_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def connection_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def reserved_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reserved_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NetworkState:
    def __init__(__self__, *,
                 ...
                 connection_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 dns_config: Optional[pulumi.Input['NetworkDnsConfigArgs']] = None,
                 dns_domain: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_suffix: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 zonal_subdomains: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 zone_infos: Optional[pulumi.Input[Sequence[pulumi.Input['NetworkZoneInfoArgs']]]] = None,
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: The name of the Network.
        :param pulumi.Input['NetworkDnsConfigArgs'] dns_config: Network DNS config. It applies only to the PRIVATELINK network connection type.
        :param pulumi.Input[builtins.str] dns_domain: (Optional String) The root DNS domain for the network, for example, `pr123a.us-east-2.aws.confluent.cloud` if applicable. Present on Networks that support Private Link.
        :param pulumi.Input[builtins.str] endpoint_suffix: (Optional String) The endpoint suffix for the network, if applicable. It can take various forms (for example, `.pr1jy6.us-east-2.aws.confluent.cloud` or `-pr1jy6.us-east-2.aws.confluent.cloud`). Full service endpoints can be constructed by appending the service identifier to the beginning of the endpoint suffix. For example, the Flink REST endpoint can be constructed by adding `flink` — that is, `https://flink` + `endpoint_suffix`; namely, `https://flink.pr1jy6.us-east-2.aws.confluent.cloud`.
        :param pulumi.Input['NetworkEnvironmentArgs'] environment: Environment objects represent an isolated namespace for your Confluent resources for organizational purposes.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkGatewayArgs']]] gateways: (Optional Configuration Block) supports the following:
        :param pulumi.Input[Sequence[pulumi.Input['NetworkGcpArgs']]] gcps: (Optional Configuration Block) The GCP-specific network details if available. It supports the following:
        :param pulumi.Input[builtins.str] region: The cloud provider region where the network exists.
        :param pulumi.Input[builtins.str] reserved_cidr: The reserved IPv4 CIDR block to be used for the network. Must be `/24`. If not specified, Confluent Cloud Network uses `172.20.255.0/24`.
        :param pulumi.Input[builtins.str] resource_name: (Required String) The Confluent Resource Name of the Network.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] zonal_subdomains: (Optional Map) The DNS subdomain for each zone. Present on networks that support Private Link. Keys are zone names, for example, `use2-az1` and values are DNS domains, for example, `use2-az1.pr123a.us-east-2.aws.confluent.cloud`.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkZoneInfoArgs']]] zone_infos: Each item represents information related to a single zone.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: The 3 availability zones for this network. They can optionally be specified for AWS networks
               used with PrivateLink, for GCP networks used with Private Service Connect, and for AWS and GCP
               networks used with Peering. Otherwise, they are automatically chosen by Confluent Cloud.
    ...
    @property
    @pulumi.getter(name="connectionTypes")
    def connection_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of connection types that may be used with the network. Accepted connection types are: `PEERING`, `TRANSITGATEWAY`, and `PRIVATELINK`.
        """
        return pulumi.get(self, "connection_types")
    ...
    @connection_types.setter
    def connection_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "connection_types", value)
    ...
    def endpoint_suffix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_suffix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def zonal_subdomains(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def zonal_subdomains(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class Network(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            zonal_subdomains: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zone_infos: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkZoneInfoArgs', 'NetworkZoneInfoArgsDict']]]]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Network':
        """
        ...
        :param pulumi.Input[builtins.str] region: The cloud provider region where the network exists.
        :param pulumi.Input[builtins.str] reserved_cidr: The reserved IPv4 CIDR block to be used for the network. Must be `/24`. If not specified, Confluent Cloud Network uses `172.20.255.0/24`.
        :param pulumi.Input[builtins.str] resource_name_: (Required String) The Confluent Resource Name of the Network.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] zonal_subdomains: (Optional Map) The DNS subdomain for each zone. Present on networks that support Private Link. Keys are zone names, for example, `use2-az1` and values are DNS domains, for example, `use2-az1.pr123a.us-east-2.aws.confluent.cloud`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['NetworkZoneInfoArgs', 'NetworkZoneInfoArgsDict']]]] zone_infos: Each item represents information related to a single zone.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: The 3 availability zones for this network. They can optionally be specified for AWS networks
               used with PrivateLink, for GCP networks used with Private Service Connect, and for AWS and GCP
    ...
    @property
    @pulumi.getter(name="connectionTypes")
    def connection_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of connection types that may be used with the network. Accepted connection types are: `PEERING`, `TRANSITGATEWAY`, and `PRIVATELINK`.
        """
        return pulumi.get(self, "connection_types")
    ...
    @property
    @pulumi.getter(name="endpointSuffix")
    def endpoint_suffix(self) -> pulumi.Output[builtins.str]:
        """
        (Optional String) The endpoint suffix for the network, if applicable. It can take various forms (for example, `.pr1jy6.us-east-2.aws.confluent.cloud` or `-pr1jy6.us-east-2.aws.confluent.cloud`). Full service endpoints can be constructed by appending the service identifier to the beginning of the endpoint suffix. For example, the Flink REST endpoint can be constructed by adding `flink` — that is, `https://flink` + `endpoint_suffix`; namely, `https://flink.pr1jy6.us-east-2.aws.confluent.cloud`.
        """
        return pulumi.get(self, "endpoint_suffix")
    ...
    @property
    @pulumi.getter(name="reservedCidr")
    def reserved_cidr(self) -> pulumi.Output[builtins.str]:
        """
        The reserved IPv4 CIDR block to be used for the network. Must be `/24`. If not specified, Confluent Cloud Network uses `172.20.255.0/24`.
        """
        return pulumi.get(self, "reserved_cidr")
    ...
    @property
    @pulumi.getter(name="zonalSubdomains")
    def zonal_subdomains(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        (Optional Map) The DNS subdomain for each zone. Present on networks that support Private Link. Keys are zone names, for example, `use2-az1` and values are DNS domains, for example, `use2-az1.pr123a.us-east-2.aws.confluent.cloud`.
        """
        return pulumi.get(self, "zonal_subdomains")
