...
class GetKafkaClusterResult:
    ...
    """
    def __init__(__self__, api_version=None, availability=None, basics=None, bootstrap_endpoint=None, cloud=None, dedicated=None, display_name=None, environment=None, http_endpoint=None, id=None, kind=None, networks=None, rbac_crn=None, region=None, standards=None):
