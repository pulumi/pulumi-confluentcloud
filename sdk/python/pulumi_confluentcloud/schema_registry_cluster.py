...
class SchemaRegistryCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            environment = _utilities.configure(environment, SchemaRegistryClusterEnvironmentArgs, True)
            ...
            region = _utilities.configure(region, SchemaRegistryClusterRegionArgs, True)
