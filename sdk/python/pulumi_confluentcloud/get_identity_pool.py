...
def get_identity_pool(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: A human-readable name for the Identity Pool.
    :param builtins.str id: The ID of the Identity Pool, for example, `pool-xyz456`.
...
def get_identity_pool_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
