...
class CertificateAuthorityArgs:
    def __init__(__self__, *,
                 ...
                 certificate_chain_filename: pulumi.Input[builtins.str],
                 description: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 crl_chain: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def certificate_chain_filename(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def certificate_chain_filename(self, value: pulumi.Input[builtins.str]):
    ...
    @crl_chain.setter
    def crl_chain(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "crl_chain", value)

    @property
    @pulumi.getter(name="crlUrl")
    def crl_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @crl_url.setter
    def crl_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CertificateAuthorityState:
    def __init__(__self__, *,
                 ...
                 certificate_chain_filename: Optional[pulumi.Input[builtins.str]] = None,
                 crl_chain: Optional[pulumi.Input[builtins.str]] = None,
                 crl_source: Optional[pulumi.Input[builtins.str]] = None,
                 crl_updated_at: Optional[pulumi.Input[builtins.str]] = None,
                 crl_url: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 expiration_dates: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 fingerprints: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] description: A description of the Certificate Authority.
        :param pulumi.Input[builtins.str] display_name: The name of the Certificate Authority.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expiration_dates: (Required List of Strings) The expiration dates of certificates in the chain.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fingerprints: (Required List of Strings) The fingerprints for each certificate in the certificate chain.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] serial_numbers: (Required List of Strings) The serial numbers for each certificate in the certificate chain.
        """
    ...
    @property
    @pulumi.getter(name="certificateChainFilename")
    def certificate_chain_filename(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the certificate file.
        """
        return pulumi.get(self, "certificate_chain_filename")
    ...
    @certificate_chain_filename.setter
    def certificate_chain_filename(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "certificate_chain_filename", value)
    ...
    def crl_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @crl_source.setter
    def crl_source(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "crl_source", value)

    @property
    @pulumi.getter(name="crlUpdatedAt")
    def crl_updated_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def crl_updated_at(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def expiration_dates(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def expiration_dates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "expiration_dates", value)

    @property
    @pulumi.getter
    def fingerprints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @fingerprints.setter
    def fingerprints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "fingerprints", value)

    @property
    @pulumi.getter(name="serialNumbers")
    def serial_numbers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def serial_numbers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class CertificateAuthority(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expiration_dates: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            fingerprints: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            serial_numbers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'CertificateAuthority':
        """
    ...
    @property
    @pulumi.getter(name="certificateChainFilename")
    def certificate_chain_filename(self) -> pulumi.Output[builtins.str]:
        """
        The name of the certificate file.
        """
        return pulumi.get(self, "certificate_chain_filename")
    ...
    @property
    @pulumi.getter(name="crlSource")
    def crl_source(self) -> pulumi.Output[builtins.str]:
        """
        (Optional String) The source specifies whether the Certificate Revocation List (CRL) is updated from either local file uploaded (LOCAL) or from url of CRL (URL).
        """
        return pulumi.get(self, "crl_source")
    ...
    @property
    @pulumi.getter(name="crlUpdatedAt")
    def crl_updated_at(self) -> pulumi.Output[builtins.str]:
        """
        (Optional String) The timestamp for when CRL was last updated.
        """
        return pulumi.get(self, "crl_updated_at")
    ...
    @property
    @pulumi.getter(name="crlUrl")
    def crl_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The url from which to fetch the CRL for the certificate authority.
        """
        return pulumi.get(self, "crl_url")
    ...
    @property
    @pulumi.getter(name="expirationDates")
    def expiration_dates(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Required List of Strings) The expiration dates of certificates in the chain.
        """
        return pulumi.get(self, "expiration_dates")
    ...
    @property
    @pulumi.getter
    def fingerprints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Required List of Strings) The fingerprints for each certificate in the certificate chain.
        """
        return pulumi.get(self, "fingerprints")
    ...
    @property
    @pulumi.getter(name="serialNumbers")
    def serial_numbers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Required List of Strings) The serial numbers for each certificate in the certificate chain.
        """
        return pulumi.get(self, "serial_numbers")
