...
def get_user(email: Optional[builtins.str] = None,
    ...
    :param builtins.str full_name: The full name of the User.
    :param builtins.str id: The ID of the User (e.g., `u-abc123`).
    """
    __args__ = dict()
...
def get_user_output(email: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    full_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
