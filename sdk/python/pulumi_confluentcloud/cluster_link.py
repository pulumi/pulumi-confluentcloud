...
class ClusterLinkArgs:
    def __init__(__self__, *,
                 ...
                 link_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] config: The custom cluster link settings to set:
        :param pulumi.Input[builtins.str] connection_mode: The connection mode of the cluster link. The supported values are `"INBOUND"` and `"OUTBOUND"`. Defaults to `"OUTBOUND"`.
        :param pulumi.Input[builtins.str] link: The name of the cluster link, for example, `my-cluster-link`.
        :param pulumi.Input[builtins.str] link_mode: The mode of the cluster link. The supported values are `"DESTINATION"`, `"SOURCE"`, and `"BIDIRECTIONAL"`. Defaults to `"DESTINATION"`.
        """
    ...
    def link_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @link_mode.setter
    def link_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClusterLinkState:
    def __init__(__self__, *,
                 cluster_link_id: Optional[pulumi.Input[builtins.str]] = None,
                 config: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 connection_mode: Optional[pulumi.Input[builtins.str]] = None,
                 destination_kafka_cluster: Optional[pulumi.Input['ClusterLinkDestinationKafkaClusterArgs']] = None,
                 link: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_link_id: (Required String) The actual Cluster Link ID assigned from Confluent Cloud that uniquely represents a link between two Kafka clusters, for example, `qz0HDEV-Qz2B5aPFpcWQJQ`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] config: The custom cluster link settings to set:
        :param pulumi.Input[builtins.str] connection_mode: The connection mode of the cluster link. The supported values are `"INBOUND"` and `"OUTBOUND"`. Defaults to `"OUTBOUND"`.
        :param pulumi.Input[builtins.str] link: The name of the cluster link, for example, `my-cluster-link`.
        :param pulumi.Input[builtins.str] link_mode: The mode of the cluster link. The supported values are `"DESTINATION"`, `"SOURCE"`, and `"BIDIRECTIONAL"`. Defaults to `"DESTINATION"`.
    ...
    def cluster_link_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_link_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterLink(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="clusterLinkId")
    def cluster_link_id(self) -> pulumi.Output[builtins.str]:
        """
        (Required String) The actual Cluster Link ID assigned from Confluent Cloud that uniquely represents a link between two Kafka clusters, for example, `qz0HDEV-Qz2B5aPFpcWQJQ`.
        """
        return pulumi.get(self, "cluster_link_id")
    ...
    @property
    @pulumi.getter(name="linkMode")
    def link_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The mode of the cluster link. The supported values are `"DESTINATION"`, `"SOURCE"`, and `"BIDIRECTIONAL"`. Defaults to `"DESTINATION"`.
        """
        return pulumi.get(self, "link_mode")
