...
class ConnectorArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if config_nonsensitive is None and 'configNonsensitive' in kwargs:
            config_nonsensitive = kwargs['configNonsensitive']
        if config_nonsensitive is None:
            raise TypeError("Missing 'config_nonsensitive' argument")
        ...
        if config_sensitive is None and 'configSensitive' in kwargs:
            config_sensitive = kwargs['configSensitive']
...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            environment = _utilities.configure(environment, ConnectorEnvironmentArgs, True)
