...
class Schema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            credentials = _utilities.configure(credentials, SchemaCredentialsArgs, True)
            ...
            schema_registry_cluster = _utilities.configure(schema_registry_cluster, SchemaSchemaRegistryClusterArgs, True)
