...
def get_private_link_access(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: A human-readable name for the Private Link Access.
...
def get_private_link_access_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
