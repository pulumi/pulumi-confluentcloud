...
def get_schema_registry_cluster(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: The name for the Schema Registry cluster.
...
def get_schema_registry_cluster_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
