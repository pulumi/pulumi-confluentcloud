...
class DnsRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain: The fully qualified domain name of the DNS Record.
        ...
        :param pulumi.Input[builtins.str] display_name: The name of the DNS Record.
        """
