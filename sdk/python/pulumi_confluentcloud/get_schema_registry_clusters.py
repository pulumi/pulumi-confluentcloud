...
def get_schema_registry_clusters_output(environment: pulumi.Input[Optional[Optional[Union['GetSchemaRegistryClustersEnvironmentArgs', 'GetSchemaRegistryClustersEnvironmentArgsDict']]]] = None,
