...
class TagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the tag to be created.
        :param pulumi.Input[builtins.str] name: The name of the tag, for example, `PII`. The name must not be empty and consist of a letter followed by a sequence of letter, number, space, or _ characters.
...
class _TagState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TagCredentialsArgs'] credentials: The Cluster API Credentials.
        :param pulumi.Input[builtins.str] description: The description of the tag to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] entity_types: (Optional List of String) The entity types of the tag, this always returns `["cf_entity"]`. Refer to the [Entity types](https://docs.confluent.io/cloud/current/stream-governance/stream-catalog-rest-apis.html#entity-types) to learn more about entity types.
        :param pulumi.Input[builtins.str] name: The name of the tag, for example, `PII`. The name must not be empty and consist of a letter followed by a sequence of letter, number, space, or _ characters.
        :param pulumi.Input[builtins.str] rest_endpoint: The REST endpoint of the Schema Registry cluster, for example, `https://psrc-00000.us-central1.gcp.confluent.cloud:443`).
        :param pulumi.Input[builtins.int] version: (Optional Integer) The version, for example, `1`.
        """
        if credentials is not None:
            pulumi.set(__self__, "credentials", credentials)
        if description is not None:
...
class Tag(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        `Tag` provides a Tag resource that enables creating, editing, and deleting Tags on Confluent Cloud.
    ...
    def get(resource_name: str,
            ...
            rest_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            schema_registry_cluster: Optional[pulumi.Input[Union['TagSchemaRegistryClusterArgs', 'TagSchemaRegistryClusterArgsDict']]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Tag':
        """
    ...
    @property
    @pulumi.getter(name="entityTypes")
    def entity_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Optional List of String) The entity types of the tag, this always returns `["cf_entity"]`. Refer to the [Entity types](https://docs.confluent.io/cloud/current/stream-governance/stream-catalog-rest-apis.html#entity-types) to learn more about entity types.
        """
        return pulumi.get(self, "entity_types")
