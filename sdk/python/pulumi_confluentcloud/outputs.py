...
class AccessPointAwsEgressPrivateLinkEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_high_availability: Optional[builtins.bool] = None,
                 vpc_endpoint_dns_name: Optional[builtins.str] = None,
                 vpc_endpoint_id: Optional[builtins.str] = None):
        """
        :param builtins.str vpc_endpoint_service_name: AWS VPC Endpoint Service that can be used to establish connections for all zones, for example `com.amazonaws.vpce.us-west-2.vpce-svc-0d3be37e21708ecd3`.
        :param builtins.bool enable_high_availability: Whether a resource should be provisioned with high availability. Endpoints deployed with high availability have network interfaces deployed in multiple AZs. Defaults to `false`.
        :param builtins.str vpc_endpoint_dns_name: (Required String) The DNS name of a VPC Endpoint (if any) that is connected to the VPC Endpoint service, for example, `*.vpce-00000000000000000-abcd1234.s3.us-west-2.vpce.amazonaws.com`.
        :param builtins.str vpc_endpoint_id: (Required String) The ID of a VPC Endpoint (if any) that is connected to the VPC Endpoint service, for example, `vpce-00000000000000000`.
        """
    ...
    def enable_high_availability(self) -> Optional[builtins.bool]:
        """
    ...
    def vpc_endpoint_dns_name(self) -> Optional[builtins.str]:
        """
...
class AccessPointAwsPrivateNetworkInterface(dict):
    ...
    def __init__(__self__, *,
                 ...
                 network_interfaces: Sequence[builtins.str]):
        """
        :param builtins.str account: (Required String) The AWS account ID associated with the ENIs you are using for the Confluent Private Network Interface, for example: `000000000000`.
        :param Sequence[builtins.str] network_interfaces: (Required List of Strings) List of the IDs of the Elastic Network Interfaces, for example: `["eni-00000000000000000", "eni-00000000000000001", "eni-00000000000000002", "eni-00000000000000003", "eni-00000000000000004", "eni-00000000000000005"]`
        """
...
class AccessPointAzureEgressPrivateLinkEndpoint(dict):
    ...
    def __init__(__self__, *,
                 private_link_service_resource_id: builtins.str,
                 private_endpoint_custom_dns_config_domains: Optional[Sequence[builtins.str]] = None,
                 private_endpoint_domain: Optional[builtins.str] = None,
                 private_endpoint_ip_address: Optional[builtins.str] = None,
                 private_endpoint_resource_id: Optional[builtins.str] = None,
                 private_link_subresource_name: Optional[builtins.str] = None):
        """
        :param builtins.str private_link_service_resource_id: Resource ID of the Azure Private Link service.
        :param Sequence[builtins.str] private_endpoint_custom_dns_config_domains: (Required List of Strings) Domains of the Private Endpoint (if any) based off FQDNs in Azure custom DNS configs, which are required in your private DNS setup, for example: `["dbname.database.windows.net", "dbname-region.database.windows.net"]`.
        :param builtins.str private_endpoint_domain: (Required String) Domain of the Private Endpoint (if any) that is connected to the Private Link service.
        :param builtins.str private_endpoint_ip_address: (Required String) IP address of the Private Endpoint (if any) that is connected to the Private Link service.
        :param builtins.str private_endpoint_resource_id: (Required String) Resource ID of the Private Endpoint (if any) that is connected to the Private Link service.
        :param builtins.str private_link_subresource_name: Name of the subresource for the Private Endpoint to connect to.
        """
    ...
    def private_endpoint_custom_dns_config_domains(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def private_endpoint_domain(self) -> Optional[builtins.str]:
        """
    ...
    def private_endpoint_resource_id(self) -> Optional[builtins.str]:
        """
    ...
    def private_link_subresource_name(self) -> Optional[builtins.str]:
        """
...
class AccessPointEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Access Point belongs to, for example, `env-abc123`.
        """
...
class AccessPointGateway(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the gateway to which the Access Point belongs, for example, `gw-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class AccessPointGcpEgressPrivateServiceConnectEndpoint(dict):
    ...
    def __init__(__self__, *,
                 private_service_connect_endpoint_target: builtins.str,
                 private_service_connect_endpoint_connection_id: Optional[builtins.str] = None,
                 private_service_connect_endpoint_ip_address: Optional[builtins.str] = None,
                 private_service_connect_endpoint_name: Optional[builtins.str] = None):
        """
        :param builtins.str private_service_connect_endpoint_target: URI of the service attachment for the published service that the Private Service Connect Endpoint connects to, or "all-google-apis" for global Google APIs.
        :param builtins.str private_service_connect_endpoint_connection_id: (Required String) Connection ID of the Private Service Connect Endpoint that is connected to the endpoint target.
        :param builtins.str private_service_connect_endpoint_ip_address: (Required String) IP address of the Private Service Connect Endpoint that is connected to the endpoint target.
        :param builtins.str private_service_connect_endpoint_name: (Required String) Name of the Private Service Connect Endpoint that is connected to the endpoint target.
        """
    ...
    def private_service_connect_endpoint_target(self) -> builtins.str:
        """
    ...
    def private_service_connect_endpoint_connection_id(self) -> Optional[builtins.str]:
        """
    ...
    def private_service_connect_endpoint_ip_address(self) -> Optional[builtins.str]:
        """
    ...
    def private_service_connect_endpoint_name(self) -> Optional[builtins.str]:
        """
...
class ApiKeyManagedResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str api_version: The API group and version of the managed resource that the API Key associated with, for example, `cmk/v2`.
        :param builtins.str id: The ID of the managed resource that the API Key associated with, for example, `lkc-abc123`.
        :param builtins.str kind: The kind of the managed resource that the API Key associated with, for example, `Cluster`.
        """
...
class ApiKeyManagedResourceEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the managed resource belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class ApiKeyOwner(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kind: builtins.str):
        """
        :param builtins.str api_version: The API group and version of the owner that the API Key belongs to, for example, `iam/v2`.
        :param builtins.str id: The ID of the owner that the API Key belongs to, for example, `sa-abc123` or `u-abc123`.
        :param builtins.str kind: The kind of the owner that the API Key belongs to, for example, `ServiceAccount` or `User`.
        """
        pulumi.set(__self__, "api_version", api_version)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "kind", kind)
...
class BusinessMetadataAttributeDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str default_value: The default value of this attribute.
        :param builtins.str description: The description of this attribute.
        :param builtins.bool is_optional: An optional flag to control whether the attribute should be optional or required. The default value is `false`.
        :param Mapping[str, builtins.str] options: (Optional Map) Block for the attribute options:
        ...
        :param builtins.str type: (Required String) The type of the attribute, it always returns `string`.
        """
...
class BusinessMetadataBindingCredentials(dict):
    def __init__(__self__, *,
                 ...
                 secret: builtins.str):
        """
        :param builtins.str key: The Schema Registry API Key.
        :param builtins.str secret: The Schema Registry API Secret.
        """
...
class BusinessMetadataBindingSchemaRegistryCluster(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Schema Registry cluster, for example, `lsrc-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class BusinessMetadataCredentials(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The Schema Registry API Key.
        :param builtins.str secret: The Cluster API Secret for your Confluent Cloud cluster.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "secret", secret)
...
class ByokKeyAws(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_arn: The Amazon Resource Name (ARN) of an AWS KMS key.
        :param Sequence[builtins.str] roles: (Optional List of Strings) The Amazon Resource Names (ARNs) of IAM Roles created for this key-environment
        """
...
class ByokKeyAzure(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_identifier: The unique Key Object Identifier URL of an Azure Key Vault key.
        :param builtins.str key_vault_id: Key Vault ID containing the key.
        :param builtins.str tenant_id: Tenant ID (uuid) hosting the Key Vault containing the key.
        :param builtins.str application_id: (Optional String) The Application ID created for this key-environment combination.
        """
...
class ByokKeyGcp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_id: The Google Cloud Platform key ID.
        :param builtins.str security_group: (Optional String) The Google security group created for this key.
        """
...
class CatalogIntegrationAwsGlue(dict):
    ...
    def __init__(__self__, *,
                 provider_integration_id: builtins.str):
        """
        :param builtins.str provider_integration_id: The provider integration id.
        """
        pulumi.set(__self__, "provider_integration_id", provider_integration_id)

    @property
    @pulumi.getter(name="providerIntegrationId")
    def provider_integration_id(self) -> builtins.str:
        """
...
class CatalogIntegrationCredentials(dict):
    def __init__(__self__, *,
                 ...
                 secret: builtins.str):
        """
        :param builtins.str key: The Tableflow API Key.
        :param builtins.str secret: The Cluster API Secret for your Confluent Cloud cluster.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "secret", secret)
...
class CatalogIntegrationKafkaCluster(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Kafka cluster, for example, `lkc-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class CatalogIntegrationSnowflake(dict):
    ...
    def __init__(__self__, *,
                 allowed_scope: builtins.str,
                 client_id: builtins.str,
                 client_secret: builtins.str,
                 endpoint: builtins.str,
                 warehouse: builtins.str):
        """
        :param builtins.str allowed_scope: Allowed scope of the Snowflake Open Catalog.
        :param builtins.str client_id: The client ID of the catalog integration.
        :param builtins.str client_secret: The client secret of the catalog integration.
        :param builtins.str endpoint: The catalog integration connection endpoint for Snowflake Open Catalog.
        :param builtins.str warehouse: Warehouse name of the Snowflake Open Catalog, for example, `catalog-name`.
        """
    ...
    def allowed_scope(self) -> builtins.str:
        """
...
class CertificatePoolCertificateAuthority(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Certificate Authority for this Certificate Pool, for example, `op-123abc`.
        """
        pulumi.set(__self__, "id", id)
...
class ClusterLinkDestinationKafkaCluster(dict):
    ...
    def __init__(__self__, *,
                 id: builtins.str,
                 bootstrap_endpoint: Optional[builtins.str] = None,
                 credentials: Optional['outputs.ClusterLinkDestinationKafkaClusterCredentials'] = None,
                 rest_endpoint: Optional[builtins.str] = None):
        """
        :param builtins.str id: The ID of the destination Kafka cluster, for example, `lkc-abc123`.
        :param builtins.str bootstrap_endpoint: The bootstrap endpoint of the destination Kafka cluster, for example, `SASL_SSL://pkc-00000.us-central1.gcp.confluent.cloud:9092` or `pkc-00000.us-central1.gcp.confluent.cloud:9092`).
        :param 'ClusterLinkDestinationKafkaClusterCredentialsArgs' credentials: The Kafka API Credentials.
        :param builtins.str rest_endpoint: The REST endpoint of the destination Kafka cluster, for example, `https://pkc-00000.us-central1.gcp.confluent.cloud:443`).
        """
        pulumi.set(__self__, "id", id)
    ...
    def bootstrap_endpoint(self) -> Optional[builtins.str]:
        """
...
class ClusterLinkDestinationKafkaClusterCredentials(dict):
    def __init__(__self__, *,
                 ...
                 secret: builtins.str):
        """
        :param builtins.str key: The Kafka API Key.
        :param builtins.str secret: The Kafka API Secret.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "secret", secret)
...
class ClusterLinkLocalKafkaCluster(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rest_endpoint: Optional[builtins.str] = None):
        """
        :param builtins.str id: The ID of the local Kafka cluster, for example, `lkc-abc123`.
        :param builtins.str bootstrap_endpoint: The bootstrap endpoint of the local Kafka cluster, for example, `SASL_SSL://pkc-00000.us-central1.gcp.confluent.cloud:9092` or `pkc-00000.us-central1.gcp.confluent.cloud:9092`).
        :param 'ClusterLinkLocalKafkaClusterCredentialsArgs' credentials: The Kafka API Credentials.
        :param builtins.str rest_endpoint: The REST endpoint of the local Kafka cluster, for example, `https://pkc-00000.us-central1.gcp.confluent.cloud:443`).
        """
        pulumi.set(__self__, "id", id)
        if bootstrap_endpoint is not None:
            pulumi.set(__self__, "bootstrap_endpoint", bootstrap_endpoint)
...
class ClusterLinkRemoteKafkaCluster(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rest_endpoint: Optional[builtins.str] = None):
        """
        :param builtins.str id: The ID of the remote Kafka cluster, for example, `lkc-abc123`.
        :param builtins.str bootstrap_endpoint: The bootstrap endpoint of the remote Kafka cluster, for example, `SASL_SSL://pkc-00000.us-central1.gcp.confluent.cloud:9092` or `pkc-00000.us-central1.gcp.confluent.cloud:9092`).
        :param 'ClusterLinkRemoteKafkaClusterCredentialsArgs' credentials: The Kafka API Credentials.
        :param builtins.str rest_endpoint: The REST endpoint of the remote Kafka cluster, for example, `https://pkc-00000.us-central1.gcp.confluent.cloud:443`).
        """
        pulumi.set(__self__, "id", id)
        if bootstrap_endpoint is not None:
            pulumi.set(__self__, "bootstrap_endpoint", bootstrap_endpoint)
...
class ClusterLinkSourceKafkaCluster(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rest_endpoint: Optional[builtins.str] = None):
        """
        :param builtins.str id: The ID of the source Kafka cluster, for example, `lkc-abc123`.
        :param builtins.str bootstrap_endpoint: The bootstrap endpoint of the source Kafka cluster, for example, `SASL_SSL://pkc-00000.us-central1.gcp.confluent.cloud:9092` or `pkc-00000.us-central1.gcp.confluent.cloud:9092`).
        :param 'ClusterLinkSourceKafkaClusterCredentialsArgs' credentials: The Kafka API Credentials.
        :param builtins.str rest_endpoint: The REST endpoint of the source Kafka cluster, for example, `https://pkc-00000.us-central1.gcp.confluent.cloud:443`).
        """
        pulumi.set(__self__, "id", id)
        if bootstrap_endpoint is not None:
            pulumi.set(__self__, "bootstrap_endpoint", bootstrap_endpoint)
...
class ConnectorEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the connector belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class ConnectorKafkaCluster(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Kafka cluster that the connector belongs to, for example, `lkc-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class ConnectorOffset(dict):
    ...
    @property
    @pulumi.getter
    def offset(self) -> Mapping[str, builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def partition(self) -> Mapping[str, builtins.str]:
        """
...
class DnsForwarderEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the DNS Forwarder belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class DnsForwarderForwardViaGcpDnsZones(dict):
    ...
    def __init__(__self__, *,
                 domain_mappings: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Mapping[str, builtins.str] domain_mappings: List of Maps which contains the domain to zone and project mapping.
    ...
    def domain_mappings(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class DnsForwarderForwardViaIp(dict):
    ...
    def __init__(__self__, *,
                 dns_server_ips: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] dns_server_ips: List of IP addresses of the DNS server.
        """
...
class DnsForwarderGateway(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the gateway to which the DNS Forwarder belongs, for example, `gw-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class DnsRecordEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the DNS Record belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class DnsRecordGateway(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the gateway to which the DNS Record belongs, for example, `gw-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class DnsRecordPrivateLinkAccessPoint(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Private Link access point to which the DNS Record is associated, for example `ap-123abc`.
        """
        pulumi.set(__self__, "id", id)
...
class EnvironmentStreamGovernance(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str package: The [stream governance package](https://docs.confluent.io/cloud/current/stream-governance/packages.html#packages) for the Environment. Accepted values are: `ESSENTIALS` and `ADVANCED`.
        """
...
class FlinkArtifactEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Flink Artifact Pool belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class FlinkArtifactVersion(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str version: The version of this Flink Artifact.
        """
...
class FlinkComputePoolEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Flink Compute Pool belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class FlinkConnectionCredentials(dict):
    def __init__(__self__, *,
                 ...
                 secret: builtins.str):
        """
        :param builtins.str key: The Cluster API Key for your Confluent Cloud cluster.
        :param builtins.str secret: The Cluster API Secret for your Confluent Cloud cluster.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "secret", secret)
...
class FlinkStatementPrincipal(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Principal the Flink Statement runs as, for example, `sa-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GatewayAwsEgressPrivateLinkGateway(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: AWS region of the Gateway, for example, `us-east-1`.
        :param builtins.str principal_arn: (Required String) The principal ARN used by the AWS Egress Private Link Gateway, for example, `arn:aws:iam::123456789012:tenant-1-role`.
        """
...
class GatewayAwsPrivateNetworkInterfaceGateway(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: AWS region of the Private Network Interface Gateway.
        :param Sequence[builtins.str] zones: AWS availability zone ids of the Private Network Interface Gateway.
        :param builtins.str account: (Required String) The AWS account ID associated with the Private Network Interface Gateway.
        """
        pulumi.set(__self__, "region", region)
...
class GatewayAzureEgressPrivateLinkGateway(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: Azure region of the Gateway, for example, `eastus`.
        :param builtins.str subscription: (Required String) The Azure Subscription ID associated with the Confluent Cloud VPC, for example, `00000000-0000-0000-0000-000000000000`.
        """
        pulumi.set(__self__, "region", region)
...
class GatewayEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Gateway belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class IdentityPoolIdentityProvider(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Identity Provider associated with the Identity Pool, for example, `op-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class InvitationCreator(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: (Required String) The id of invitation creator.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class KafkaClientQuotaEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the corresponding Kafka Cluster belongs to, for example, `env-abc123`.
...
class KafkaClientQuotaKafkaCluster(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Kafka Cluster where the Kafka Client Quota is applied, for example, `lkc-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class KafkaClientQuotaThroughput(dict):
    ...
    def __init__(__self__, *,
                 egress_byte_rate: builtins.str,
                 ingress_byte_rate: builtins.str):
        """
        :param builtins.str egress_byte_rate: The egress throughput limit in bytes per second.
        :param builtins.str ingress_byte_rate: The ingress throughput limit in bytes per second.
        """
    ...
    def egress_byte_rate(self) -> builtins.str:
        """
    ...
    def ingress_byte_rate(self) -> builtins.str:
        """
...
class KafkaClusterByokKey(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Confluent key that is used to encrypt the data in the Kafka cluster, for example, `cck-lye5m`.
        """
        pulumi.set(__self__, "id", id)
...
class KafkaClusterConfigKafkaCluster(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Dedicated Kafka cluster, for example, `lkc-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class KafkaClusterDedicated(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int cku: The number of Confluent Kafka Units (CKUs) for Dedicated cluster types. The minimum number of CKUs for `SINGLE_ZONE` dedicated clusters is `1` whereas `MULTI_ZONE` dedicated clusters must have `2` CKUs or more.
        ...
        :param builtins.str encryption_key: The ID of the encryption key that is used to encrypt the data in the Kafka cluster.
        :param Sequence[builtins.str] zones: (Required List of String) The list of zones the cluster is in.
...
class KafkaClusterEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Kafka cluster belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class KafkaClusterNetwork(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network that the Kafka cluster belongs to, for example, `n-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class KafkaMirrorTopicClusterLink(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str link_name: The name of the cluster link to attach to the mirror topic, for example, `my-cluster-link`.
        """
...
class KafkaMirrorTopicSourceKafkaTopic(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str topic_name: The name of the topic on the source cluster to be mirrored over the cluster link, for example, `orders`. A topic with the exact same name must exist on the source cluster, and no topic with this name should exist on the destination cluster.
        """
...
class KsqlClusterCredentialIdentity(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the associated service or user account, for example, `sa-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class KsqlClusterEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the associated Environment, for example, `env-xyz456`.
        """
        pulumi.set(__self__, "id", id)
...
class KsqlClusterKafkaCluster(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the associated Kafka cluster, for example, `lkc-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class NetworkAw(dict):
    ...
    def __init__(__self__, *,
                 account: Optional[builtins.str] = None,
                 private_link_endpoint_service: Optional[builtins.str] = None,
                 vpc: Optional[builtins.str] = None):
        """
        :param builtins.str account: (Required String) The AWS account ID associated with the Confluent Cloud VPC.
        :param builtins.str private_link_endpoint_service: (Optional String) The endpoint service of the Confluent Cloud VPC (used for PrivateLink) if available.
        :param builtins.str vpc: (Required String) The Confluent Cloud VPC ID.
        """
        if account is not None:
            pulumi.set(__self__, "account", account)
    ...
    def private_link_endpoint_service(self) -> Optional[builtins.str]:
        """
...
class NetworkAzure(dict):
    ...
    def __init__(__self__, *,
                 private_link_service_aliases: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Mapping[str, builtins.str] private_link_service_aliases: (Optional Map) The mapping of zones to Private Link Service Aliases if available. Keys are zone names, for example, `1` and values are [Azure Private Link Service Aliases](https://docs.microsoft.com/en-us/azure/private-link/private-link-service-overview#share-your-service), for example, `s-nk99e-privatelink-1.8c43dcd0-695c-1234-bc35-11fe6abb303a.centralus.azure.privatelinkservice`.
        """
    ...
    def private_link_service_aliases(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class NetworkDnsConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resolution: Network DNS resolution.
...
class NetworkEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Network belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class NetworkGateway(dict):
    def __init__(__self__, *,
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str id: (Optional String) The ID of the Gateway, for example, `gw-abc123`.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class NetworkGcp(dict):
    ...
    def __init__(__self__, *,
                 private_service_connect_service_attachments: Optional[Mapping[str, builtins.str]] = None,
                 project: Optional[builtins.str] = None,
                 vpc_network: Optional[builtins.str] = None):
        """
        :param Mapping[str, builtins.str] private_service_connect_service_attachments: (Optional Map) The mapping of zones to Private Service Connect Service Attachments if available. Keys are zones and values are [GCP Private Service Connect service attachment](https://cloud.google.com/vpc/docs/configure-private-service-connect-producer#api_7).
        :param builtins.str project: (Required String) The GCP Project ID associated with the Confluent Cloud VPC.
        :param builtins.str vpc_network: (Required String) The network name of the Confluent Cloud VPC.
        """
    ...
    def private_service_connect_service_attachments(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def vpc_network(self) -> Optional[builtins.str]:
        """
...
class NetworkLinkEndpointEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Network Link Endpoint belongs to, for example, `env-xyz456`.
        """
        pulumi.set(__self__, "id", id)
...
class NetworkLinkEndpointNetwork(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network that the Network Link Endpoint belongs to, for example, `n-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class NetworkLinkEndpointNetworkLinkService(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network Link Service, for example, `nls-g3e1ox`.
        """
        pulumi.set(__self__, "id", id)
...
class NetworkLinkServiceAccept(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] environments: List of environments ids from which connections can be accepted. All networks within the list of environment will be allowed.
        :param Sequence[builtins.str] networks: List of network ids from which connections can be accepted.
        """
...
class NetworkLinkServiceEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Network Link Service belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class NetworkLinkServiceNetwork(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network that the Network Link Service belongs to, for example, `n-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class NetworkZoneInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cidr: The IPv4 CIDR block to be used for the network. Must be `/27`. Required for VPC peering and AWS TransitGateway.
        :param builtins.str zone_id: Cloud provider zone ID.
        """
        if cidr is not None:
...
class PeeringAws(dict):
    ...
    def __init__(__self__, *,
                 account: builtins.str,
                 customer_region: builtins.str,
                 routes: Sequence[builtins.str],
                 vpc: builtins.str):
        """
        :param builtins.str account: The AWS Account ID of the peer VPC owner. You can find your AWS Account ID [here](https://console.aws.amazon.com/billing/home?#/account) under **My Account** section of the AWS Management Console. Must be a **12 character string**.
        :param builtins.str customer_region: The region of the AWS peer VPC.
        :param Sequence[builtins.str] routes: The AWS VPC CIDR blocks or subsets. This must be from the supported CIDR blocks and must not overlap with your Confluent Cloud CIDR block or any other network peering connection VPC CIDR (learn more about the requirements [here](https://docs.confluent.io/cloud/current/networking/peering/aws-peering.html#vpc-peering-on-aws)). You can find AWS VPC CIDR [here](https://console.aws.amazon.com/vpc/) under **Your VPCs > Target VPC > Details** section of the AWS Management Console.
        :param builtins.str vpc: The AWS VPC ID of the peer VPC that you're peering with Confluent Cloud. You can find your AWS VPC ID [here](https://console.aws.amazon.com/vpc/) under **Your VPCs** section of the AWS Management Console. Must start with `vpc-`.
        """
        pulumi.set(__self__, "account", account)
    ...
    def customer_region(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def routes(self) -> Sequence[builtins.str]:
        """
        The AWS VPC CIDR blocks or subsets. This must be from the supported CIDR blocks and must not overlap with your Confluent Cloud CIDR block or any other network peering connection VPC CIDR (learn more about the requirements [here](https://docs.confluent.io/cloud/current/networking/peering/aws-peering.html#vpc-peering-on-aws)). You can find AWS VPC CIDR [here](https://console.aws.amazon.com/vpc/) under **Your VPCs > Target VPC > Details** section of the AWS Management Console.
        """
...
class PeeringEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Peering belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class PeeringGcp(dict):
    ...
    def __init__(__self__, *,
                 ...
                 import_custom_routes: Optional[builtins.bool] = None):
        """
        :param builtins.str project: The GCP Project ID. You can find your Google Cloud Project ID under **Project ID** section of your [Google Cloud Console dashboard](https://console.cloud.google.com/home/dashboard).
        :param builtins.str vpc_network: The VPC network name that you're peering to Confluent Cloud. You can find your VPC network name under **VPC Networks** section of your [Google Cloud Console](https://console.cloud.google.com/networking/networks/list).
        :param builtins.bool import_custom_routes: The Import Custom Routes option enables connectivity to a Confluent Cloud cluster in Google Cloud from customer premise or other clouds, such as AWS and Azure, through a customer VPC that is peered with Confluent Cloud in the same region. Defaults to `false`. Learn more about considerations / limitations of the Import Custom Routes option [here](https://docs.confluent.io/cloud/current/networking/peering/gcp-peering.html#import-custom-routes).
    ...
    def import_custom_routes(self) -> Optional[builtins.bool]:
        """
...
class PeeringNetwork(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network that the Peering belongs to, for example, `n-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class PrivateLinkAccessAws(dict):
    def __init__(__self__, *,
                 account: builtins.str):
        """
        :param builtins.str account: The AWS account ID to enable for the Private Link Access. You can find your AWS account ID [here] (https://console.aws.amazon.com/billing/home?#/account) under **My Account** in your AWS Management Console. Must be a **12 character string**.
        """
        pulumi.set(__self__, "account", account)
...
class PrivateLinkAccessEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Private Link Access belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class PrivateLinkAccessGcp(dict):
    def __init__(__self__, *,
                 project: builtins.str):
        """
        :param builtins.str project: The GCP project ID to allow for Private Service Connect access. You can find your Google Cloud Project ID under **Project ID** section of your [Google Cloud Console dashboard](https://console.cloud.google.com/home/dashboard).
...
class PrivateLinkAccessNetwork(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network that the Private Link Access belongs to, for example, `n-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class PrivateLinkAttachmentAw(dict):
    ...
    def __init__(__self__, *,
                 vpc_endpoint_service_name: Optional[builtins.str] = None):
        """
        :param builtins.str vpc_endpoint_service_name: (Required String) AWS VPC Endpoint Service that can be used to establish connections for all zones, for example `com.amazonaws.vpce.us-west-2.vpce-svc-0d3be37e21708ecd3`.
        """
...
class PrivateLinkAttachmentAzure(dict):
    ...
    def __init__(__self__, *,
                 private_link_service_alias: Optional[builtins.str] = None,
                 private_link_service_resource_id: Optional[builtins.str] = None):
        """
        :param builtins.str private_link_service_alias: Azure PrivateLink service alias for the availability zone.
        :param builtins.str private_link_service_resource_id: (Required String) Azure Private Link service resource id for the availability zone.
        """
    ...
    def private_link_service_alias(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="privateLinkServiceResourceId")
    def private_link_service_resource_id(self) -> Optional[builtins.str]:
        """
...
class PrivateLinkAttachmentConnectionAws(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str vpc_endpoint_id: ID of a VPC Endpoint that is connected to the VPC Endpoint service.
        """
        pulumi.set(__self__, "vpc_endpoint_id", vpc_endpoint_id)
...
class PrivateLinkAttachmentConnectionAzure(dict):
    ...
    def __init__(__self__, *,
                 private_endpoint_resource_id: builtins.str):
        """
        :param builtins.str private_endpoint_resource_id: Resource ID of the Private Endpoint that is connected to the Private Link service.
        """
        pulumi.set(__self__, "private_endpoint_resource_id", private_endpoint_resource_id)
...
class PrivateLinkAttachmentConnectionEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Private Link Attachment Connection belongs to, for example `env-xyz456`.
        """
        pulumi.set(__self__, "id", id)
...
class PrivateLinkAttachmentConnectionGcp(dict):
    ...
    def __init__(__self__, *,
                 private_service_connect_connection_id: builtins.str):
        """
        :param builtins.str private_service_connect_connection_id: GCP Private Service Connect ID used to establish connections for all zones.
        """
    ...
    def private_service_connect_connection_id(self) -> builtins.str:
        """
...
class PrivateLinkAttachmentConnectionPrivateLinkAttachment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The unique identifier for the private link attachment.
        """
        pulumi.set(__self__, "id", id)
...
class PrivateLinkAttachmentEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Private Link Attachment belongs to, for example `env-xyz456`.
        """
        pulumi.set(__self__, "id", id)
...
class PrivateLinkAttachmentGcp(dict):
    ...
    def __init__(__self__, *,
                 private_service_connect_service_attachment: Optional[builtins.str] = None):
        """
        :param builtins.str private_service_connect_service_attachment: Id of a Private Service Connect Service Attachment in Confluent Cloud.
        """
    ...
    def private_service_connect_service_attachment(self) -> Optional[builtins.str]:
        """
...
class ProviderIntegrationAws(dict):
    ...
    def __init__(__self__, *,
                 customer_role_arn: builtins.str,
                 external_id: Optional[builtins.str] = None,
                 iam_role_arn: Optional[builtins.str] = None):
        """
        :param builtins.str customer_role_arn: Amazon Resource Name (ARN) that identifies the AWS Identity and Access Management (IAM) role that Confluent Cloud assumes when it accesses resources in your AWS account.
        ...
        :param builtins.str external_id: (Required String) Unique external ID that Confluent Cloud uses when it assumes the IAM role in your Amazon Web Services (AWS) account.
        :param builtins.str iam_role_arn: (Required String) The IAM role ARN used in Confluent Cloud internally, bundled with `customer_role_arn`.
        """
    ...
    def customer_role_arn(self) -> builtins.str:
        """
...
class ProviderIntegrationEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Provider Integration belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class SchemaExporterDestinationSchemaRegistryCluster(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str rest_endpoint: The REST endpoint of the destination Schema Registry cluster, for example, `https://pkc-00000.us-central1.gcp.confluent.cloud:443`).
        """
        pulumi.set(__self__, "credentials", credentials)
        pulumi.set(__self__, "rest_endpoint", rest_endpoint)
...
class SchemaMetadata(dict):
    def __init__(__self__, *,
                 ...
                 sensitives: Optional[Sequence[builtins.str]] = None,
                 tags: Optional[Sequence['outputs.SchemaMetadataTag']] = None):
        """
        :param Mapping[str, builtins.str] properties: The custom properties to set:
        :param Sequence[builtins.str] sensitives: A list of metadata properties to be encrypted.
        """
    ...
    @property
    @pulumi.getter
    def sensitives(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SchemaRulesetDomainRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 doc: Optional[builtins.str] = None,
...
class SchemaSchemaReference(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the Schema references (for example, "io.confluent.kafka.example.User"). For Avro, the reference name is the fully qualified schema name, for JSON Schema it is a URL, and for Protobuf, it is the name of another Protobuf file.
        :param builtins.str subject_name: The name of the subject (in other words, the namespace), representing the subject under which the schema will be registered, for example, `test-subject`. Schemas evolve safely, following a compatibility mode defined, under a subject name.
        :param builtins.int version: (Required Integer) The version of the Schema, for example, `4`.
        """
        pulumi.set(__self__, "name", name)
...
class TableflowTopicByobAws(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str provider_integration_id: The provider integration id.
        :param builtins.str bucket_region: (Required String) The bucket region.
        """
...
class TransitGatewayAttachmentAws(dict):
    ...
    def __init__(__self__, *,
                 ram_resource_share_arn: builtins.str,
                 routes: Sequence[builtins.str],
                 transit_gateway_id: builtins.str,
                 transit_gateway_attachment_id: Optional[builtins.str] = None):
        """
        :param builtins.str ram_resource_share_arn: The Amazon Resource Name (ARN) of the Resource Access Manager (RAM) Resource Share of the transit gateway your Confluent Cloud network attaches to.
        :param Sequence[builtins.str] routes: List of destination routes for traffic from Confluent VPC to customer VPC via Transit Gateway.
        ...
        :param builtins.str transit_gateway_id: The ID of the AWS Transit Gateway that you want Confluent CLoud to be attached to. Must start with `tgw-`.
        :param builtins.str transit_gateway_attachment_id: (Required String) The ID of the AWS Transit Gateway VPC Attachment that attaches Confluent VPC to Transit Gateway.
        """
    ...
    def ram_resource_share_arn(self) -> builtins.str:
        """
...
class TransitGatewayAttachmentEnvironment(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Transit Gateway Attachment belongs to, for example, `env-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class TransitGatewayAttachmentNetwork(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network that the Transit Gateway Attachment belongs to, for example, `n-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GetAccessPointAwsEgressPrivateLinkEndpointResult(dict):
    def __init__(__self__, *,
                 enable_high_availability: builtins.bool,
                 vpc_endpoint_dns_name: builtins.str,
                 vpc_endpoint_id: builtins.str,
                 vpc_endpoint_service_name: builtins.str):
        """
        :param builtins.bool enable_high_availability: (Required Boolean) Whether a resource should be provisioned with high availability. Endpoints deployed with high availability have network interfaces deployed in multiple AZs. Defaults to `false`.
        :param builtins.str vpc_endpoint_dns_name: (Required String) The DNS name of a VPC Endpoint (if any) that is connected to the VPC Endpoint service, for example, `*.vpce-00000000000000000-abcd1234.s3.us-west-2.vpce.amazonaws.com`.
        :param builtins.str vpc_endpoint_id: (Required String) The ID of a VPC Endpoint (if any) that is connected to the VPC Endpoint service, for example, `vpce-00000000000000000`.
        :param builtins.str vpc_endpoint_service_name: (Required String) AWS VPC Endpoint Service that can be used to establish connections for all zones, for example `com.amazonaws.vpce.us-west-2.vpce-svc-0d3be37e21708ecd3`.
        """
    ...
    @property
    @pulumi.getter(name="enableHighAvailability")
    def enable_high_availability(self) -> builtins.bool:
        """
...
class GetAccessPointAzureEgressPrivateLinkEndpointResult(dict):
    def __init__(__self__, *,
                 private_endpoint_custom_dns_config_domains: Sequence[builtins.str],
                 private_endpoint_domain: builtins.str,
                 private_endpoint_ip_address: builtins.str,
                 private_endpoint_resource_id: builtins.str,
                 private_link_service_resource_id: builtins.str,
                 private_link_subresource_name: builtins.str):
        """
        :param Sequence[builtins.str] private_endpoint_custom_dns_config_domains: (Required List of Strings) Domains of the Private Endpoint (if any) based off FQDNs in Azure custom DNS configs, which are required in your private DNS setup, for example: `["dbname.database.windows.net", "dbname-region.database.windows.net"]`.
        :param builtins.str private_endpoint_domain: (Required String) Domain of the Private Endpoint (if any) that is connected to the Private Link service.
        :param builtins.str private_endpoint_ip_address: (Required String) IP address of the Private Endpoint (if any) that is connected to the Private Link service.
        :param builtins.str private_endpoint_resource_id: (Required String) Resource ID of the Private Endpoint (if any) that is connected to the Private Link service.
        :param builtins.str private_link_service_resource_id: (Required String) Resource ID of the Azure Private Link service.
        :param builtins.str private_link_subresource_name: (Required String) Name of the subresource for the Private Endpoint to connect to.
        """
        pulumi.set(__self__, "private_endpoint_custom_dns_config_domains", private_endpoint_custom_dns_config_domains)
        pulumi.set(__self__, "private_endpoint_domain", private_endpoint_domain)
        pulumi.set(__self__, "private_endpoint_ip_address", private_endpoint_ip_address)
    ...
    @property
    @pulumi.getter(name="privateEndpointCustomDnsConfigDomains")
    def private_endpoint_custom_dns_config_domains(self) -> Sequence[builtins.str]:
        """
        (Required List of Strings) Domains of the Private Endpoint (if any) based off FQDNs in Azure custom DNS configs, which are required in your private DNS setup, for example: `["dbname.database.windows.net", "dbname-region.database.windows.net"]`.
        """
        return pulumi.get(self, "private_endpoint_custom_dns_config_domains")
    ...
    @property
    @pulumi.getter(name="privateEndpointDomain")
    def private_endpoint_domain(self) -> builtins.str:
        """
        (Required String) Domain of the Private Endpoint (if any) that is connected to the Private Link service.
        """
        return pulumi.get(self, "private_endpoint_domain")
    ...
    @property
    @pulumi.getter(name="privateLinkSubresourceName")
    def private_link_subresource_name(self) -> builtins.str:
        """
...
class GetAccessPointEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Access Point belongs to, for example, `env-123abc`.
        """
        pulumi.set(__self__, "id", id)
...
class GetAccessPointGatewayResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Access Point, for example, `ap-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GetAccessPointGcpEgressPrivateServiceConnectEndpointResult(dict):
    def __init__(__self__, *,
                 private_service_connect_endpoint_connection_id: builtins.str,
                 private_service_connect_endpoint_ip_address: builtins.str,
                 private_service_connect_endpoint_name: builtins.str,
                 private_service_connect_endpoint_target: builtins.str):
        """
        :param builtins.str private_service_connect_endpoint_connection_id: (Required String) Connection ID of the Private Service Connect Endpoint that is connected to the endpoint target.
        :param builtins.str private_service_connect_endpoint_ip_address: (Required String) IP address of the Private Service Connect Endpoint that is connected to the endpoint target.
        :param builtins.str private_service_connect_endpoint_name: (Required String) Name of the Private Service Connect Endpoint that is connected to the endpoint target.
        :param builtins.str private_service_connect_endpoint_target: (Required String) URI of the service attachment for the published service that the Private Service Connect Endpoint connects to, or "all-google-apis" for global Google APIs.
        """
        pulumi.set(__self__, "private_service_connect_endpoint_connection_id", private_service_connect_endpoint_connection_id)
        pulumi.set(__self__, "private_service_connect_endpoint_ip_address", private_service_connect_endpoint_ip_address)
        pulumi.set(__self__, "private_service_connect_endpoint_name", private_service_connect_endpoint_name)
    ...
    @property
    @pulumi.getter(name="privateServiceConnectEndpointConnectionId")
    def private_service_connect_endpoint_connection_id(self) -> builtins.str:
        """
        (Required String) Connection ID of the Private Service Connect Endpoint that is connected to the endpoint target.
        """
        return pulumi.get(self, "private_service_connect_endpoint_connection_id")
    ...
    @property
    @pulumi.getter(name="privateServiceConnectEndpointIpAddress")
    def private_service_connect_endpoint_ip_address(self) -> builtins.str:
        """
        (Required String) IP address of the Private Service Connect Endpoint that is connected to the endpoint target.
        """
        return pulumi.get(self, "private_service_connect_endpoint_ip_address")
    ...
    @property
    @pulumi.getter(name="privateServiceConnectEndpointName")
    def private_service_connect_endpoint_name(self) -> builtins.str:
        """
        (Required String) Name of the Private Service Connect Endpoint that is connected to the endpoint target.
        """
        return pulumi.get(self, "private_service_connect_endpoint_name")
...
class GetBusinessMetadataAttributeDefinitionResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str default_value: (Optional String) The default value of this attribute.
        :param builtins.str description: (Optional String) The description of this attribute.
        :param builtins.bool is_optional: (Optional Boolean) An optional flag to control whether the attribute should be optional or required.
        :param builtins.str name: The name of the Business Metadata, for example, `PII`. The name must not be empty and consist of a letter followed by a sequence of letter, number, space, or _ characters.
...
class GetByokKeyAwResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_arn: (Required String) The Amazon Resource Name (ARN) of an AWS KMS key.
        :param Sequence[builtins.str] roles: (Optional List of Strings) The Amazon Resource Names (ARNs) of IAM Roles created for this key-environment combination.
        """
        pulumi.set(__self__, "key_arn", key_arn)
        pulumi.set(__self__, "roles", roles)
...
class GetByokKeyAzureResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str application_id: (Optional String) The Application ID created for this key-environment combination.
        :param builtins.str key_identifier: (Required String) The unique Key Object Identifier URL of an Azure Key Vault key.
        :param builtins.str key_vault_id: (Required String) Key Vault ID containing the key.
        :param builtins.str tenant_id: (Required String) Tenant ID (uuid) hosting the Key Vault containing the key.
        """
        pulumi.set(__self__, "application_id", application_id)
        pulumi.set(__self__, "key_identifier", key_identifier)
        pulumi.set(__self__, "key_vault_id", key_vault_id)
...
class GetByokKeyGcpResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_id: (Required String) The Google Cloud Platform key ID.
        :param builtins.str security_group: (Optional String) The Google security group created for this key.
        """
        pulumi.set(__self__, "key_id", key_id)
        pulumi.set(__self__, "security_group", security_group)
...
class GetCatalogIntegrationAwsGlueResult(dict):
    def __init__(__self__, *,
                 provider_integration_id: builtins.str):
        """
        :param builtins.str provider_integration_id: (Required String) The provider integration id.
        """
        pulumi.set(__self__, "provider_integration_id", provider_integration_id)
...
class GetCatalogIntegrationSnowflakeResult(dict):
    def __init__(__self__, *,
                 ...
                 warehouse: builtins.str):
        """
        :param builtins.str allowed_scope: (Required String) Allowed scope of the Snowflake Open Catalog.
        :param builtins.str endpoint: (Required String) The catalog integration connection endpoint for Snowflake Open Catalog.
        :param builtins.str warehouse: (Required String) Warehouse name of the Snowflake Open Catalog.
        """
        pulumi.set(__self__, "allowed_scope", allowed_scope)
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "warehouse", warehouse)
...
class GetClusterLinkKafkaClusterResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Kafka cluster to query for the Cluster Link, for example, `lkc-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GetDnsRecordEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the DNS Record belongs to, for example, `env-123abc`.
        """
        pulumi.set(__self__, "id", id)
...
class GetDnsRecordGatewayResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the DNS Record, for example, `dnsrec-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GetEnvironmentStreamGovernanceResult(dict):
    def __init__(__self__, *,
                 package: builtins.str):
        """
        :param builtins.str package: Stream Governance Package. 'ESSENTIALS' or 'ADVANCED'
        """
        pulumi.set(__self__, "package", package)
...
class GetFlinkArtifactEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Flink Artifact belongs to, for example, `env-xyz456`.
        """
        pulumi.set(__self__, "id", id)
...
class GetFlinkComputePoolEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Flink Compute Pool belongs to, for example, `env-xyz456`.
...
class GetGatewayAwsEgressPrivateLinkGatewayResult(dict):
    def __init__(__self__, *,
                 ...
                 region: builtins.str):
        """
        :param builtins.str principal_arn: (Required String) The principal ARN used by the AWS Egress Private Link Gateway.
        :param builtins.str region: (Required String) GCP region of the Peering Gateway.
        """
        pulumi.set(__self__, "principal_arn", principal_arn)
        pulumi.set(__self__, "region", region)
...
class GetGatewayAwsPrivateNetworkInterfaceGatewayResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str account: (Required String) The AWS account ID associated with the Private Network Interface Gateway.
        :param builtins.str region: (Required String) GCP region of the Peering Gateway.
        :param Sequence[builtins.str] zones: (Required List of Strings) AWS availability zone ids of the Private Network Interface Gateway.
        """
        pulumi.set(__self__, "account", account)
        pulumi.set(__self__, "region", region)
        pulumi.set(__self__, "zones", zones)
...
class GetGatewayAzureEgressPrivateLinkGatewayResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: (Required String) GCP region of the Peering Gateway.
        :param builtins.str subscription: (Required String) The Azure Subscription ID associated with the Confluent Cloud VPC.
        """
        pulumi.set(__self__, "region", region)
        pulumi.set(__self__, "subscription", subscription)
...
class GetGatewayEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Gateway belongs to, for example, `env-123abc`.
        """
        pulumi.set(__self__, "id", id)
...
class GetGatewayGcpEgressPrivateServiceConnectGatewayResult(dict):
    def __init__(__self__, *,
                 ...
                 region: builtins.str):
        """
        :param builtins.str project: (Required String) The GCP project used by the GCP Private Service Connect Gateway.
        :param builtins.str region: (Required String) GCP region of the Peering Gateway.
        """
        pulumi.set(__self__, "project", project)
        pulumi.set(__self__, "region", region)
...
class GetGatewayGcpPeeringGatewayResult(dict):
    def __init__(__self__, *,
                 iam_principal: builtins.str,
                 region: builtins.str):
        """
        :param builtins.str iam_principal: (Required String) The IAM principal used by the GCP Peering Gateway.
        :param builtins.str region: (Required String) GCP region of the Peering Gateway.
        """
    ...
    def iam_principal(self) -> builtins.str:
        """
...
class GetInvitationCreatorResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Invitation, for example, `i-zyw30`.
        """
        pulumi.set(__self__, "id", id)
...
class GetIpAddressesFilterResult(dict):
    def __init__(__self__, *,
                 address_types: Optional[Sequence[builtins.str]] = None,
                 clouds: Optional[Sequence[builtins.str]] = None,
                 regions: Optional[Sequence[builtins.str]] = None,
                 services: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] address_types: A list of address types to filter by. Accepted values are: `EGRESS`, `INGRESS`.
        :param Sequence[builtins.str] clouds: A list of clouds to filter by. Accepted values are: `AWS`, `AZURE`, and `GCP`.
        :param Sequence[builtins.str] regions: A list of regions to filter by.
        :param Sequence[builtins.str] services: A list of services to filter by. Accepted values are: `CONNECT`, `KAFKA`.
        """
    ...
    def address_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def clouds(self) -> Optional[Sequence[builtins.str]]:
        """
...
class GetIpAddressesIpAddressResult(dict):
    def __init__(__self__, *,
                 ...
                 api_version: builtins.str,
                 cloud: builtins.str,
                 ip_prefix: builtins.str,
                 kind: builtins.str,
                 region: builtins.str,
                 services: Sequence[builtins.str]):
        """
        :param builtins.str address_type: (Required Integer) Whether the address is used for egress or ingress.
        :param builtins.str api_version: (Required String) An API Version of the schema version of the IP Address, for example, `networking/v1`.
        :param builtins.str cloud: (Required String) The cloud service provider in which the address exists.
        :param builtins.str ip_prefix: (Required String) The IP Address range.
        :param builtins.str kind: (Required String) A kind of the Kafka cluster, for example, `IpAddress`.
        :param builtins.str region: (Required Integer) The region/location where the IP Address is in use.
        :param Sequence[builtins.str] services: (Required List of Strings) The service types that will use the address.
        """
...
class GetKafkaClientQuotaEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Kafka Client Quota (for example, `cq-abc123`).
        """
        pulumi.set(__self__, "id", id)
...
class GetKafkaClientQuotaThroughputResult(dict):
    def __init__(__self__, *,
                 ...
                 ingress_byte_rate: builtins.str):
        """
        :param builtins.str egress_byte_rate: (Required String) The egress throughput limit in bytes per second.
        :param builtins.str ingress_byte_rate: (Required String) The ingress throughput limit in bytes per second.
        """
        pulumi.set(__self__, "egress_byte_rate", egress_byte_rate)
        pulumi.set(__self__, "ingress_byte_rate", ingress_byte_rate)
...
class GetKafkaClusterDedicatedResult(dict):
    def __init__(__self__, *,
                 ...
                 zones: Sequence[builtins.str]):
        """
        :param builtins.int cku: (Required Number) The number of Confluent Kafka Units (CKUs) for Dedicated cluster types. The minimum number of CKUs for `SINGLE_ZONE` dedicated clusters is `1` whereas `MULTI_ZONE` dedicated clusters must have `2` CKUs or more.
        :param builtins.str encryption_key: The ID of the encryption key that is used to encrypt the data in the Kafka cluster.
        :param Sequence[builtins.str] zones: (Required List of String) The list of zones the cluster is in.
               - On AWS, zones are AWS [AZ IDs](https://docs.aws.amazon.com/ram/latest/userguide/working-with-az-ids.html), for example, `use1-az3`.
...
class GetKafkaClusterEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Kafka cluster belongs to, for example, `env-xyz456`.
...
class GetKsqlClusterCredentialIdentityResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the ksqlDB cluster, for example, `lksqlc-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GetKsqlClusterEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the ksqlDB cluster belongs to, for example, `env-xyz456`.
...
class GetNetworkAwResult(dict):
    def __init__(__self__, *,
                 account: builtins.str,
                 private_link_endpoint_service: builtins.str,
                 vpc: builtins.str):
        """
        :param builtins.str account: (Required String) The AWS account ID associated with the Confluent Cloud VPC.
        :param builtins.str private_link_endpoint_service: (Optional String) The endpoint service of the Confluent Cloud VPC (used for PrivateLink) if available.
    ...
    @property
    @pulumi.getter(name="privateLinkEndpointService")
    def private_link_endpoint_service(self) -> builtins.str:
        """
        (Optional String) The endpoint service of the Confluent Cloud VPC (used for PrivateLink) if available.
        """
        return pulumi.get(self, "private_link_endpoint_service")
...
class GetNetworkAzureResult(dict):
    def __init__(__self__, *,
                 private_link_service_aliases: Mapping[str, builtins.str]):
        """
        :param Mapping[str, builtins.str] private_link_service_aliases: (Optional Map) The mapping of zones to Private Link Service Aliases if available. Keys are zones and values are [Azure Private Link Service Aliases](https://docs.microsoft.com/en-us/azure/private-link/private-link-service-overview#share-your-service).
        """
        pulumi.set(__self__, "private_link_service_aliases", private_link_service_aliases)

    @property
    @pulumi.getter(name="privateLinkServiceAliases")
    def private_link_service_aliases(self) -> Mapping[str, builtins.str]:
        """
...
class GetNetworkDnsConfigResult(dict):
    def __init__(__self__, *,
                 resolution: builtins.str):
        """
        :param builtins.str resolution: (Required String) Network DNS resolution.
               When resolution is `CHASED_PRIVATE`, clusters in this network require both public and private DNS to resolve cluster endpoints.
               When resolution is `PRIVATE`, clusters in this network only require private DNS to resolve cluster endpoints.
        """
        pulumi.set(__self__, "resolution", resolution)
...
class GetNetworkEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Network belongs to, for example, `env-xyz456`.
...
class GetNetworkGatewayResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network, for example, `n-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GetNetworkGcpResult(dict):
    def __init__(__self__, *,
                 private_service_connect_service_attachments: Mapping[str, builtins.str],
                 project: builtins.str,
                 vpc_network: builtins.str):
        """
        :param Mapping[str, builtins.str] private_service_connect_service_attachments: (Optional Map) The mapping of zones to Private Service Connect Service Attachments if available. Keys are zones and values are [GCP Private Service Connect service attachment](https://cloud.google.com/vpc/docs/configure-private-service-connect-producer#api_7).
    ...
    @property
    @pulumi.getter(name="privateServiceConnectServiceAttachments")
    def private_service_connect_service_attachments(self) -> Mapping[str, builtins.str]:
        """
        (Optional Map) The mapping of zones to Private Service Connect Service Attachments if available. Keys are zones and values are [GCP Private Service Connect service attachment](https://cloud.google.com/vpc/docs/configure-private-service-connect-producer#api_7).
        """
        return pulumi.get(self, "private_service_connect_service_attachments")
...
class GetNetworkLinkEndpointNetworkResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network Link Endpoint, for example, `nle-zyw30`.
        """
        pulumi.set(__self__, "id", id)
...
class GetNetworkLinkServiceAcceptResult(dict):
    def __init__(__self__, *,
                 environments: Sequence[builtins.str],
                 networks: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] environments: (Optional List of Strings) List of environments ids from which connections can be accepted. All networks within the list of environment will be allowed.
        :param Sequence[builtins.str] networks: (Optional List of Strings) List of network ids from which connections can be accepted.
        """
        pulumi.set(__self__, "environments", environments)
        pulumi.set(__self__, "networks", networks)
...
class GetNetworkLinkServiceEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Network Link Service belongs to, for example, `env-1234`.
...
class GetNetworkLinkServiceNetworkResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Network Link Service, for example, `nls-zyw30`.
        """
        pulumi.set(__self__, "id", id)
...
class GetNetworkZoneInfoResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cidr: (Required String) The IPv4 CIDR block to be used for the network. Must be `/27`. Required for VPC peering and AWS TransitGateway.
        :param builtins.str zone_id: (Required String) Cloud provider zone ID.
        """
        pulumi.set(__self__, "cidr", cidr)
        pulumi.set(__self__, "zone_id", zone_id)
...
class GetPeeringAwResult(dict):
    def __init__(__self__, *,
                 ...
                 vpc: builtins.str):
        """
        :param builtins.str account: (Required String) The AWS Account ID of the peer VPC owner. You can find your AWS Account ID [here](https://console.aws.amazon.com/billing/home?#/account) under **My Account** section of the AWS Management Console. Must be a **12 character string**.
        :param builtins.str customer_region: (Required String) The region of the Azure peer VNet.
        :param Sequence[builtins.str] routes: (Required String) The AWS VPC CIDR blocks or subsets. This must be from the supported CIDR blocks and must not overlap with your Confluent Cloud CIDR block or any other network peering connection VPC CIDR (learn more about the requirements [here](https://docs.confluent.io/cloud/current/networking/peering/aws-peering.html#vpc-peering-on-aws)). You can find AWS VPC CIDR [here](https://console.aws.amazon.com/vpc/) under **Your VPCs > Target VPC > Details** section of the AWS Management Console.
        :param builtins.str vpc: (Required String) The AWS VPC ID of the peer VPC that you're peering with Confluent Cloud. You can find your AWS VPC ID [here](https://console.aws.amazon.com/vpc/) under **Your VPCs** section of the AWS Management Console. Must start with `vpc-`.
        """
        pulumi.set(__self__, "account", account)
        pulumi.set(__self__, "customer_region", customer_region)
        pulumi.set(__self__, "routes", routes)
...
class GetPeeringAzureResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str customer_region: (Required String) The region of the Azure peer VNet.
        :param builtins.str tenant: (Required String) The Tenant ID that represents an organization in Azure Active Directory. You can find your Azure Tenant ID in the [Azure Portal under Azure Active Directory](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/Overview). Must be a valid **32 character UUID string**.
        :param builtins.str vnet: (Required String) The resource (composite) ID of the peer Virtual Network that you're peering with Confluent Cloud, in the format `/subscriptions/<Subscription ID>/resourceGroups/<Resource Group Name>/providers/Microsoft.Network/virtualNetworks/<VNet name>`. You can find Subscription ID, Resource Group Name and your VNet name under **Virtual Networks > Target VNet > Essentials** section of your [Microsoft Azure Portal](https://portal.azure.com/).
        """
        pulumi.set(__self__, "customer_region", customer_region)
        pulumi.set(__self__, "tenant", tenant)
        pulumi.set(__self__, "vnet", vnet)
...
class GetPeeringEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Peering belongs to, for example, `env-xyz456`.
...
class GetPeeringGcpResult(dict):
    def __init__(__self__, *,
                 ...
                 vpc_network: builtins.str):
        """
        :param builtins.bool import_custom_routes: (Optional Boolean) The Import Custom Routes option enables connectivity to a Confluent Cloud cluster in Google Cloud from customer premise or other clouds, such as AWS and Azure, through a customer VPC that is peered with Confluent Cloud in the same region. Defaults to `false`. Learn more about considerations / limitations of the Import Custom Routes option [here](https://docs.confluent.io/cloud/current/networking/peering/gcp-peering.html#import-custom-routes).
        :param builtins.str project: (Required String) The GCP Project ID. You can find your Google Cloud Project ID under **Project ID** section of your [Google Cloud Console dashboard](https://console.cloud.google.com/home/dashboard).
        :param builtins.str vpc_network: (Required String) The VPC network name that you're peering to Confluent Cloud. You can find your VPC network name under **VPC Networks** section of your [Google Cloud Console](https://console.cloud.google.com/networking/networks/list).
        """
        pulumi.set(__self__, "import_custom_routes", import_custom_routes)
        pulumi.set(__self__, "project", project)
        pulumi.set(__self__, "vpc_network", vpc_network)
...
class GetPeeringNetworkResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Peering, for example, `peer-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GetPrivateLinkAccessAwResult(dict):
    def __init__(__self__, *,
                 account: builtins.str):
        """
        :param builtins.str account: (Required String) The AWS account ID to enable for the Private Link Access. You can find your AWS account ID [here](https://console.aws.amazon.com/billing/home?#/account) under **My Account** in your AWS Management Console. Must be a **12 character string**.
        """
        pulumi.set(__self__, "account", account)
...
class GetPrivateLinkAccessAzureResult(dict):
    def __init__(__self__, *,
                 subscription: builtins.str):
        """
        :param builtins.str subscription: (Required String) The Azure subscription ID to enable for the Private Link Access. You can find your Azure subscription ID in the subscription section of your [Microsoft Azure Portal](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade). Must be a valid **32 character UUID string**.
        """
        pulumi.set(__self__, "subscription", subscription)
...
class GetPrivateLinkAccessEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Private Link Access belongs to, for example, `env-xyz456`.
...
class GetPrivateLinkAccessGcpResult(dict):
    def __init__(__self__, *,
                 project: builtins.str):
        """
        :param builtins.str project: (Required String) The GCP project ID to allow for Private Service Connect access. You can find your Google Cloud Project ID under **Project ID** section of your [Google Cloud Console dashboard](https://console.cloud.google.com/home/dashboard).
        """
        pulumi.set(__self__, "project", project)
...
class GetPrivateLinkAccessNetworkResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Private Link Access, for example, `pla-abc123`.
        """
        pulumi.set(__self__, "id", id)
...
class GetPrivateLinkAttachmentAzureResult(dict):
    def __init__(__self__, *,
                 private_link_service_alias: builtins.str,
                 private_link_service_resource_id: builtins.str):
        """
        :param builtins.str private_link_service_alias: Azure PrivateLink service alias for the availability zone.
        :param builtins.str private_link_service_resource_id: (Required String) Azure Private Link service resource id for the availability zone.
    ...
    @property
    @pulumi.getter(name="privateLinkServiceAlias")
    def private_link_service_alias(self) -> builtins.str:
        """
        Azure PrivateLink service alias for the availability zone.
        """
        return pulumi.get(self, "private_link_service_alias")
...
class GetPrivateLinkAttachmentConnectionAwResult(dict):
    def __init__(__self__, *,
                 vpc_endpoint_id: builtins.str):
        """
        :param builtins.str vpc_endpoint_id: (Required String) Id of a VPC Endpoint that is connected to the VPC Endpoint service.
        """
        pulumi.set(__self__, "vpc_endpoint_id", vpc_endpoint_id)
...
class GetPrivateLinkAttachmentConnectionAzureResult(dict):
    def __init__(__self__, *,
                 private_endpoint_resource_id: builtins.str):
        """
        :param builtins.str private_endpoint_resource_id: (Required String) Resource ID of the Private Endpoint that is connected to the Private Link service.
        """
        pulumi.set(__self__, "private_endpoint_resource_id", private_endpoint_resource_id)
...
class GetPrivateLinkAttachmentConnectionGcpResult(dict):
    def __init__(__self__, *,
                 private_service_connect_connection_id: builtins.str):
        """
        :param builtins.str private_service_connect_connection_id: (Required String) GCP Private Service Connect ID used to establish connections for all zones.
        """
        pulumi.set(__self__, "private_service_connect_connection_id", private_service_connect_connection_id)
...
class GetPrivateLinkAttachmentGcpResult(dict):
    def __init__(__self__, *,
                 private_service_connect_service_attachment: builtins.str):
        """
        :param builtins.str private_service_connect_service_attachment: Id of a Private Service Connect Service Attachment in Confluent Cloud.
        """
        pulumi.set(__self__, "private_service_connect_service_attachment", private_service_connect_service_attachment)
    ...
    @property
    @pulumi.getter(name="privateServiceConnectServiceAttachment")
    def private_service_connect_service_attachment(self) -> builtins.str:
        """
        Id of a Private Service Connect Service Attachment in Confluent Cloud.
        """
        return pulumi.get(self, "private_service_connect_service_attachment")
...
class GetProviderIntegrationAwResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str customer_role_arn: (Required String) Amazon Resource Name (ARN) that identifies the AWS Identity and Access Management (IAM) role that Confluent Cloud assumes when it accesses resources in your AWS account, and must be unique in the same environment.
        :param builtins.str external_id: (Required String) Unique external ID that Confluent Cloud uses when it assumes the IAM role in your Amazon Web Services (AWS) account.
        :param builtins.str iam_role_arn: (Required String) The IAM role ARN used in Confluent Cloud internally, bundled with `customer_role_arn`.
        """
        pulumi.set(__self__, "customer_role_arn", customer_role_arn)
...
class GetProviderIntegrationEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Provider Integration belongs to, for example, `env-xyz456`.
...
class GetSchemaMetadataResult(dict):
    def __init__(__self__, *,
                 ...
                 sensitives: Sequence[builtins.str],
                 tags: Sequence['outputs.GetSchemaMetadataTagResult']):
        """
        :param Mapping[str, builtins.str] properties: (Optional Map) The custom properties to set:
        :param Sequence[builtins.str] sensitives: (Optional List of Strings) A list of metadata properties to be encrypted.
    ...
    @property
    @pulumi.getter
    def sensitives(self) -> Sequence[builtins.str]:
        """
...
class GetSchemaMetadataTagResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: (Required String) The setting name.
        :param Sequence[builtins.str] values: (Required List of Strings) The list of tags.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "values", values)
...
class GetSchemaRegistryClusterEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Schema Registry cluster belongs to, for example, `env-xyz456`.
        """
        pulumi.set(__self__, "id", id)
...
class GetSchemaRegistryClustersClusterResult(dict):
    def __init__(__self__, *,
                 ...
                 kind: builtins.str,
                 package: builtins.str,
                 private_regional_rest_endpoints: Mapping[str, builtins.str],
                 private_rest_endpoint: builtins.str,
                 region: builtins.str,
                 resource_name: builtins.str,
                 rest_endpoint: builtins.str):
        """
        :param builtins.str api_version: (Required String) An API Version of the schema version of the Schema Registry cluster, for example, `stream-governance/v2`.
        :param builtins.str catalog_endpoint: (Required String) The Catalog endpoint of the Schema Registry cluster, for example, `https://psrc-y1113.us-west-2.aws.confluent.cloud`.
        :param builtins.str cloud: (Required String) The cloud service provider that the Schema Registry cluster belongs to, for example, `AWS`.
        :param builtins.str display_name: (Required String) The name of the Schema Registry cluster, for example, `Stream Governance Package`.
        :param 'GetSchemaRegistryClustersClusterEnvironmentArgs' environment: (Required Object) exports the following attributes:
        :param builtins.str id: (Required String) The id of the environment.
        :param builtins.str kind: (Required String) A kind of the Schema Registry cluster, for example, `Cluster`.
        :param builtins.str package: (Required String) The type of the billing package. Accepted values are: `ESSENTIALS` and `ADVANCED`.
        :param Mapping[str, builtins.str] private_regional_rest_endpoints: (Required Map) The private regional HTTP endpoint map of the Schema Registry cluster. For example, to reference the endpoint corresponding to the us-central-1 region, use `private_regional_rest_endpoints["us-central-1"]`.
        :param builtins.str private_rest_endpoint: (Required String, **Deprecated**) The private HTTP endpoint of the Schema Registry cluster, for example, `https://lsrc.us-west-2.aws.private.stag.cpdev.cloud`. Please use the `private_regional_rest_endpoints` attribute instead, which supersedes the `private_rest_endpoint` attribute.
        :param builtins.str region: (Required String) The ID of the Schema Registry region that the Schema Registry cluster belongs to, for example, `us-east4`.
        :param builtins.str resource_name: (Required String) The Confluent Resource Name of the Schema Registry cluster, for example, `crn://confluent.cloud/organization=1111aaaa-11aa-11aa-11aa-111111aaaaaa/environment=env-abc123/schema-registry=lsrc-abc123`.
        :param builtins.str rest_endpoint: (Required String) The HTTP endpoint of the Schema Registry cluster, for example, `https://psrc-00000.us-west-2.aws.confluent.cloud`.
        """
        pulumi.set(__self__, "api_version", api_version)
    ...
    def private_regional_rest_endpoints(self) -> Mapping[str, builtins.str]:
        """
...
class GetSchemaRulesetDomainRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 on_success: Optional[builtins.str] = None):
        """
        :param builtins.str kind: (Required String) The kind of the rule. Accepted values are `CONDITION` and `TRANSFORM`. `CONDITION` - validate the value of a field, `TRANSFORM` - transform the value of a field. Data quality rules use `CONDITION` kind, data transformation, encryption and migration rules use `TRANSFORM` kind.
        :param builtins.str mode: (Required String) The mode of the rule. Accepted values are `UPGRADE`, `DOWNGRADE`, `UPDOWN`, `WRITE`, `READ`, and `WRITEREAD`.
        :param builtins.str name: (Required String) A user-defined name that can be used to reference the rule.
        :param Mapping[str, builtins.str] params: (Optional Configuration Block) A set of static parameters for the rule, which is optional. These are key-value pairs that are passed to the rule.
        :param Sequence[builtins.str] tags: (Optional String List) The tags to which the rule applies, if any.
        :param builtins.str type: (Required String) The type of rule, which invokes a specific rule executor that that will run the rule. Google Common Expression Language (`CEL`) is used for data quality and transformation rules, Confluent `ENCRYPT` is used for data encryption rules, and `JSONata` is used for migration rules.
        :param builtins.bool disabled: (Optional Boolean) The boolean flag to control whether the rule should be disabled.
...
class GetSchemasFilterResult(dict):
    def __init__(__self__, *,
                 ...
                 latest_only: Optional[builtins.bool] = None,
                 subject_prefix: Optional[builtins.str] = None):
        """
        :param builtins.bool deleted: The boolean flag to control whether to return soft deleted schemas. Defaults to `false`.
        :param builtins.bool latest_only: The boolean flag to control whether to return latest schema versions only for each matching subject. Defaults to `false`.
        :param builtins.str subject_prefix: The prefix of the subjects (in other words, the namespaces), representing the subjects under which the schemas are registered.
        """
    ...
    def latest_only(self) -> Optional[builtins.bool]:
        """
    ...
    def subject_prefix(self) -> Optional[builtins.str]:
        """
...
class GetSchemasSchemaResult(dict):
    def __init__(__self__, *,
                 format: builtins.str,
                 schema: builtins.str,
                 schema_identifier: builtins.int,
                 schema_references: Sequence['outputs.GetSchemasSchemaSchemaReferenceResult'],
                 subject_name: builtins.str,
                 version: builtins.int):
        """
        :param builtins.str format: (Required String) The format of the schema. Accepted values are: `AVRO`, `PROTOBUF`, and `JSON`.
        :param builtins.str schema: (Required String) The schema string.
        :param builtins.int schema_identifier: (Required String) The ID of the Schema, for example: `lsrc-abc123/test-subject/100003`.
        ...
        :param builtins.str subject_name: (Required String) The name for the reference. (For Avro Schema, the reference name is the fully qualified schema name, for JSON Schema it is a URL, and for Protobuf Schema, it is the name of another Protobuf file.)
        :param builtins.int version: (Required Integer) The version of the Schema, for example, `4`.
        """
    ...
    def schema_identifier(self) -> builtins.int:
        """
...
class GetSchemasSchemaSchemaReferenceResult(dict):
    def __init__(__self__, *,
                 ...
                 version: builtins.int):
        """
        :param builtins.str name: (Required String) The name of the subject, representing the subject under which the referenced schema is registered.
        :param builtins.str subject_name: (Required String) The name for the reference. (For Avro Schema, the reference name is the fully qualified schema name, for JSON Schema it is a URL, and for Protobuf Schema, it is the name of another Protobuf file.)
        :param builtins.int version: (Required Integer) The version of the Schema, for example, `4`.
        """
        pulumi.set(__self__, "name", name)
...
class GetTableflowTopicByobAwResult(dict):
    def __init__(__self__, *,
                 ...
                 provider_integration_id: builtins.str):
        """
        :param builtins.str bucket_name: (Required String) The bucket name.
        :param builtins.str bucket_region: (Required String) The bucket region.
        :param builtins.str provider_integration_id: (Required String) The provider integration id.
        """
        pulumi.set(__self__, "bucket_name", bucket_name)
...
class GetTransitGatewayAttachmentAwResult(dict):
    def __init__(__self__, *,
                 ...
                 transit_gateway_id: builtins.str):
        """
        :param builtins.str ram_resource_share_arn: (Required String) The Amazon Resource Name (ARN) of the Resource Access Manager (RAM) Resource Share of the transit gateway your Confluent Cloud network attaches to.
        :param Sequence[builtins.str] routes: (Required List of String) List of destination routes for traffic from Confluent VPC to customer VPC via Transit Gateway.
        :param builtins.str transit_gateway_attachment_id: (Required String) The ID of the AWS Transit Gateway VPC Attachment that attaches Confluent VPC to Transit Gateway.
        :param builtins.str transit_gateway_id: (Required String) The ID of the AWS Transit Gateway that you want Confluent CLoud to be attached to. Must start with `tgw-`.
        """
        pulumi.set(__self__, "ram_resource_share_arn", ram_resource_share_arn)
        pulumi.set(__self__, "routes", routes)
        pulumi.set(__self__, "transit_gateway_attachment_id", transit_gateway_attachment_id)
...
class GetTransitGatewayAttachmentEnvironmentResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Environment that the Transit Gateway Attachment belongs to, for example, `env-xyz456`.
...
class GetTransitGatewayAttachmentNetworkResult(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: The ID of the Peering, for example, `tgwa-abc123`.
        """
        pulumi.set(__self__, "id", id)
