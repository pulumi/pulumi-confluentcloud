...
class KafkaAclArgs:
    def __init__(__self__, *,
                 credentials: pulumi.Input['KafkaAclCredentialsArgs'],
        ...
        :param pulumi.Input[str] operation: The operation type for the ACL. Accepted values are: `UNKNOWN`, `ANY`, `ALL`, `READ`, `WRITE`, `CREATE`, `DELETE`, `ALTER`, `DESCRIBE`, `CLUSTER_ACTION`, `DESCRIBE_CONFIGS`, `ALTER_CONFIGS`, and `IDEMPOTENT_WRITE`.
    ...
    @property
    @pulumi.getter
    def credentials(self) -> pulumi.Input['KafkaAclCredentialsArgs']:
        """
    ...
    @credentials.setter
    def credentials(self, value: pulumi.Input['KafkaAclCredentialsArgs']):
...
class KafkaAcl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            principal: Optional[pulumi.Input[str]] = None,
            resource_name_: Optional[pulumi.Input[str]] = None,
            resource_type: Optional[pulumi.Input[str]] = None) -> 'KafkaAcl':
        """
    ...
    @property
    @pulumi.getter
    def credentials(self) -> pulumi.Output['outputs.KafkaAclCredentials']:
        """
        The Cluster API Credentials.
        """
        return pulumi.get(self, "credentials")
