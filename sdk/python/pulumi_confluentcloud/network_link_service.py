...
class NetworkLinkService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            accept = _utilities.configure(accept, NetworkLinkServiceAcceptArgs, True)
            __props__.__dict__["accept"] = accept
            __props__.__dict__["description"] = description
            __props__.__dict__["display_name"] = display_name
            environment = _utilities.configure(environment, NetworkLinkServiceEnvironmentArgs, True)
            if environment is None and not opts.urn:
                raise TypeError("Missing required property 'environment'")
            __props__.__dict__["environment"] = environment
            network = _utilities.configure(network, NetworkLinkServiceNetworkArgs, True)
