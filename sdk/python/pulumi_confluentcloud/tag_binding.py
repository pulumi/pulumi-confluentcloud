...
class TagBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] entity_type: The entity type.
        :param pulumi.Input[builtins.str] tag_name: The name of the tag to be applied, for example, `PII`. The name must not be empty and consist of a letter followed by a sequence of letter, number, space, or _ characters.
...
class TagBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rest_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            schema_registry_cluster: Optional[pulumi.Input[Union['TagBindingSchemaRegistryClusterArgs', 'TagBindingSchemaRegistryClusterArgsDict']]] = None,
            tag_name: Optional[pulumi.Input[builtins.str]] = None) -> 'TagBinding':
        """
