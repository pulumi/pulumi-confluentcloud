...
class TagBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            credentials = _utilities.configure(credentials, TagBindingCredentialsArgs, True)
            ...
            schema_registry_cluster = _utilities.configure(schema_registry_cluster, TagBindingSchemaRegistryClusterArgs, True)
