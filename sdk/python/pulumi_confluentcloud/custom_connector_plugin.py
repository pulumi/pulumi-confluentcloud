...
class CustomConnectorPluginArgs:
    def __init__(__self__, *,
                 connector_class: pulumi.Input[builtins.str],
    ...
    def connector_class(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connector_class(self, value: pulumi.Input[builtins.str]):
...
class _CustomConnectorPluginState:
    def __init__(__self__, *,
                 cloud: Optional[pulumi.Input[builtins.str]] = None,
                 connector_class: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="connectorClass")
    def connector_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Java class or alias for the connector. You can get the connector class from the connector documentation provided by the developer.
        """
        return pulumi.get(self, "connector_class")
    ...
    @connector_class.setter
    def connector_class(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "connector_class", value)
...
class CustomConnectorPlugin(pulumi.CustomResource):
    ...
    pulumi_type = "confluentcloud:index/customConnectorPlugin:CustomConnectorPlugin"
    ...
    def get(resource_name: str,
            ...
            documentation_link: Optional[pulumi.Input[builtins.str]] = None,
            filename: Optional[pulumi.Input[builtins.str]] = None,
            sensitive_config_properties: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'CustomConnectorPlugin':
        """
    ...
    @property
    @pulumi.getter(name="connectorClass")
    def connector_class(self) -> pulumi.Output[builtins.str]:
        """
        The Java class or alias for the connector. You can get the connector class from the connector documentation provided by the developer.
        """
        return pulumi.get(self, "connector_class")
