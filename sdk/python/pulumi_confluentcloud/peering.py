...
class Peering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            aws = _utilities.configure(aws, PeeringAwsArgs, True)
            __props__.__dict__["aws"] = aws
            azure = _utilities.configure(azure, PeeringAzureArgs, True)
            __props__.__dict__["azure"] = azure
            __props__.__dict__["display_name"] = display_name
            environment = _utilities.configure(environment, PeeringEnvironmentArgs, True)
            if environment is None and not opts.urn:
                raise TypeError("Missing required property 'environment'")
            __props__.__dict__["environment"] = environment
            gcp = _utilities.configure(gcp, PeeringGcpArgs, True)
            __props__.__dict__["gcp"] = gcp
            network = _utilities.configure(network, PeeringNetworkArgs, True)
