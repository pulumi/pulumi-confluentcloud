...
class BusinessMetadataBindingArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if business_metadata_name is None and 'businessMetadataName' in kwargs:
            business_metadata_name = kwargs['businessMetadataName']
        if business_metadata_name is None:
            raise TypeError("Missing 'business_metadata_name' argument")
...
class BusinessMetadataBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            credentials = _utilities.configure(credentials, BusinessMetadataBindingCredentialsArgs, True)
            ...
            schema_registry_cluster = _utilities.configure(schema_registry_cluster, BusinessMetadataBindingSchemaRegistryClusterArgs, True)
