...
namespace Pulumi.ConfluentCloud
{
    public static class GetKafkaCluster
    {
        ...
        /// {
        ///     var exampleUsingId = ConfluentCloud.Index.GetKafkaCluster.Invoke(new()
        ///     {
        ///         Id = "lkc-abc123",
        ...
        ///     });
        /// 
        ///     var test_sa = new ConfluentCloud.Index.ServiceAccount("test-sa", new()
        ///     {
        ///         DisplayName = "app_mgr",
        ///         Description = $"app_mgr for {exampleUsingId.Apply(getKafkaClusterResult =&gt; getKafkaClusterResult.DisplayName)}",
        ///     });
        /// 
        ///     var exampleUsingName = ConfluentCloud.Index.GetKafkaCluster.Invoke(new()
        ///     {
    ...
    public sealed class GetKafkaClusterArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("freights")]
        private List<Inputs.GetKafkaClusterFreightArgs>? _freights;

        /// <summary>
        /// (Optional Configuration Block) The configuration of the Freight Kafka cluster.
        /// </summary>
        public List<Inputs.GetKafkaClusterFreightArgs> Freights
        {
            get => _freights ?? (_freights = new List<Inputs.GetKafkaClusterFreightArgs>());
            set => _freights = value;
        }
    ...
    public sealed class GetKafkaClusterInvokeArgs : global::Pulumi.InvokeArgs
    {
        ...
        [Input("freights")]
        private InputList<Inputs.GetKafkaClusterFreightInputArgs>? _freights;

        /// <summary>
        /// (Optional Configuration Block) The configuration of the Freight Kafka cluster.
        /// </summary>
        public InputList<Inputs.GetKafkaClusterFreightInputArgs> Freights
        {
            get => _freights ?? (_freights = new InputList<Inputs.GetKafkaClusterFreightInputArgs>());
            set => _freights = value;
        }
    ...
    public sealed class GetKafkaClusterResult
    {
        ...
        /// (Optional Configuration Block) The configuration of the Freight Kafka cluster.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetKafkaClusterFreightResult> Freights;
        /// <summary>
        ...
        private GetKafkaClusterResult(
            ...
            ImmutableArray<Outputs.GetKafkaClusterFreightResult> freights,
