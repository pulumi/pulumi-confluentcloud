...
namespace Pulumi.ConfluentCloud
{
    ...
    ///     });
    /// 
    ///     var connectorName = Std.Lookup.Invoke(new()
    ///     {
    ...
    ///     });
    /// 
    ///     var subject_with_special_characters_example_rb = new ConfluentCloud.RoleBinding("subject-with-special-characters-example-rb", new()
    ///     {
    ///         Principal = $"User:{test.Id}",
    ///         RoleName = "DeveloperRead",
    ///         CrnPattern = $"{example.ResourceName}/subject={Std.Urlencode.Invoke(new()
    ///         {
    ///             Input = "grxevents/private/billing",
    ///         }).Result}",
    ///     });
    /// 
    ///     var subject_with_special_characters_prefix_example_rb = new ConfluentCloud.RoleBinding("subject-with-special-characters-prefix-example-rb", new()
    ///     {
    ///         Principal = $"User:{test.Id}",
    ///         RoleName = "DeveloperRead",
    ///         CrnPattern = $"{example.ResourceName}/subject={Std.Urlencode.Invoke(new()
    ...
    ///     });
    /// 
    ///     var wait360SecondsAfterRoleBinding = new Time.Sleep("wait_360_seconds_after_role_binding", new()
    ///     {
    ///         CreateDuration = "360s",
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var subject_with_special_characters = new ConfluentCloud.RoleBinding("subject-with-special-characters", new()
    ///     {
    ///         Principal = $"User:{test.Id}",
    ///         RoleName = "DeveloperRead",
    ///         CrnPattern = $"{example.ResourceName}/subject={Std.Urlencode.Invoke(new()
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var subject_with_special_characters_prefix = new ConfluentCloud.RoleBinding("subject-with-special-characters-prefix", new()
    ///     {
    ///         Principal = $"User:{test.Id}",
    ///         RoleName = "DeveloperRead",
    ///         CrnPattern = $"{example.ResourceName}/subject={Std.Urlencode.Invoke(new()
