...
namespace Pulumi.ConfluentCloud.Inputs
{
    ...
    public sealed class ClusterLinkDestinationKafkaClusterGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("credentials")]
        private Input<Inputs.ClusterLinkDestinationKafkaClusterCredentialsGetArgs>? _credentials;

        /// <summary>
        /// The Kafka API Credentials.
        /// </summary>
        public Input<Inputs.ClusterLinkDestinationKafkaClusterCredentialsGetArgs>? Credentials
        {
            get => _credentials;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _credentials = Output.Tuple<Input<Inputs.ClusterLinkDestinationKafkaClusterCredentialsGetArgs>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        public ClusterLinkDestinationKafkaClusterGetArgs()
        {
        }
        public static new ClusterLinkDestinationKafkaClusterGetArgs Empty => new ClusterLinkDestinationKafkaClusterGetArgs();
    }
}
